...
public class Get2VersionByIdV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.projectVersionsApi().get2VersionByIdV1(new Get2VersionByIdV1OperationSpec(spec -> {
            ...
            switch (response) {
                case Get2VersionByIdV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Get2VersionByIdV1Response.Unknown r -> {
