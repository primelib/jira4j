...
public class Get2AppFieldByFieldIdOrKeyContextConfigurationV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.issueCustomFieldConfigurationAppsApi().get2AppFieldByFieldIdOrKeyContextConfigurationV1(new Get2AppFieldByFieldIdOrKeyContextConfigurationV1OperationSpec(spec -> {
            ...
            switch (response) {
                case Get2AppFieldByFieldIdOrKeyContextConfigurationV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Get2AppFieldByFieldIdOrKeyContextConfigurationV1Response.Unknown r -> {
