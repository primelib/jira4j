...
public class Get2UserPropertiesV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.userPropertiesApi().get2UserPropertiesV1(new Get2UserPropertiesV1OperationSpec(spec -> {
            ...
            switch (response) {
                case Get2UserPropertiesV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Get2UserPropertiesV1Response.Unknown r -> {
