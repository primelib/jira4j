...
public class Put2UserPropertyByPropertyKeyV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.userPropertiesApi().put2UserPropertyByPropertyKeyV1(new Put2UserPropertyByPropertyKeyV1OperationSpec(spec -> {
                    ...
                    // spec.propertyKey(/* String */); // propertyKey: required - The key of the user's property. The maximum length is 255 characters.
            ...
            switch (response) {
                case Put2UserPropertyByPropertyKeyV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Put2UserPropertyByPropertyKeyV1Response.CreatedResponse r -> {
                    // handle 201, r.data() contains typed payload
                }
                case Put2UserPropertyByPropertyKeyV1Response.Unknown r -> {
