...
public class Get2UserColumnsV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.usersApi().get2UserColumnsV1(new Get2UserColumnsV1OperationSpec(spec -> {
            ...
            switch (response) {
                case Get2UserColumnsV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Get2UserColumnsV1Response.Unknown r -> {
