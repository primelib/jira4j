...
public class Put2AppFieldByFieldIdOrKeyValueV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.issueCustomFieldValuesAppsApi().put2AppFieldByFieldIdOrKeyValueV1(new Put2AppFieldByFieldIdOrKeyValueV1OperationSpec(spec -> {
                    // operation parameters (all available mutable fields)
                    // spec.fieldIdOrKey(/* String */); // fieldIdOrKey: required - The ID or key of the custom field. For example, `customfield_10010`.
                    ...
                    // spec.payload(/* CustomFieldValueUpdateDetails */); // payload: required
            ...
            switch (response) {
                case Put2AppFieldByFieldIdOrKeyValueV1Response.NoContentResponse r -> {
                    // handle 204, r.data() contains typed payload
                }
                case Put2AppFieldByFieldIdOrKeyValueV1Response.Unknown r -> {
