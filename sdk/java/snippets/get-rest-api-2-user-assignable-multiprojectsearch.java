...
public class Get2UserAssignableMultiProjectSearchV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.userSearchApi().get2UserAssignableMultiProjectSearchV1(new Get2UserAssignableMultiProjectSearchV1OperationSpec(spec -> {
                    ...
                    // spec.projectKeys(/* String */); // projectKeys: required - A list of project keys (case sensitive). This parameter accepts a comma-separated list.
            ...
            switch (response) {
                case Get2UserAssignableMultiProjectSearchV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Get2UserAssignableMultiProjectSearchV1Response.Unknown r -> {
