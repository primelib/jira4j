...
public class Delete2UserPropertyByPropertyKeyV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.userPropertiesApi().delete2UserPropertyByPropertyKeyV1(new Delete2UserPropertyByPropertyKeyV1OperationSpec(spec -> {
            ...
            switch (response) {
                case Delete2UserPropertyByPropertyKeyV1Response.Unknown r -> {
