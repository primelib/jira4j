...
public class Get2UserGroupsV1Example {
    public void execute() {
        // Maven coordinates: io.github.primelib:jira-datacenter-client:<version>
        var client = JiraDataCenterClientFactory.create();

        try {
            var response = client.usersApi().get2UserGroupsV1(new Get2UserGroupsV1OperationSpec(spec -> {
            ...
            switch (response) {
                case Get2UserGroupsV1Response.OkResponse r -> {
                    // handle 200, r.data() contains typed payload
                }
                case Get2UserGroupsV1Response.Unknown r -> {
