...
public sealed interface Post2ExpressionEvalV1Response {
    int statusCode();
    ...
    ) implements Post2ExpressionEvalV1Response {}
    ...
    */
     ...
     *
     * @return The response data payload of type {@link JiraExpressionResult}.
     * @throws IllegalStateException If the response status code is not 200.
     */
    default JiraExpressionResult data() {
        if (this instanceof OkResponse target) {
            return target.body();
        }
