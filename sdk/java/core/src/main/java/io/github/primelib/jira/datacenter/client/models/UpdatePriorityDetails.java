...
public class UpdatePriorityDetails {
     ...
     * @param avatarId The ID for the avatar for the priority. This parameter is nullable and both iconUrl and avatarId cannot be defined.
     * @param description The description of the priority.
     * @param iconUrl The URL of an icon for the priority. Accepted protocols are HTTP and HTTPS. Built in icons can also be used. Both iconUrl and avatarId cannot be defined.
     ...
     */
    @ApiStatus.Internal
    public UpdatePriorityDetails(Long avatarId, String description, String iconUrl, String name, String statusColor) {
     ...
     * @return this
     */
    public UpdatePriorityDetails iconUrl(String iconUrl) {
        this.iconUrl = iconUrl;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        UpdatePriorityDetails that = (UpdatePriorityDetails) o;
        return
