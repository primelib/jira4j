...
public class JiraExpressionEvalRequestBeanContext {
    ...
    /**
     * Constructs a validated instance of {@link JiraExpressionEvalRequestBeanContext}.
     *
     ...
     * Constructs a validated instance of {@link JiraExpressionEvalRequestBeanContext}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #JiraExpressionEvalRequestBeanContext(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public JiraExpressionEvalRequestBeanContext(Long board, List<CustomContextVariable> custom, Long customerRequest, JiraExpressionEvalContextBeanIssue issue, JiraExpressionEvalContextBeanIssues issues, JiraExpressionEvalContextBeanProject project, Long serviceDesk, Long sprint) {
        this.board = board;
        this.custom = custom;
