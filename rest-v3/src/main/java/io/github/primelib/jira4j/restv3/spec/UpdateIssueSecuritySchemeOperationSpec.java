...
public class UpdateIssueSecuritySchemeOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateIssueSecuritySchemeOperationSpec}.
     *
     ...
     * @param updateIssueSecuritySchemeRequestBean 
     */
    @ApiStatus.Internal
    public UpdateIssueSecuritySchemeOperationSpec(String id, UpdateIssueSecuritySchemeRequestBean updateIssueSecuritySchemeRequestBean) {
        this.id = id;
        this.updateIssueSecuritySchemeRequestBean = updateIssueSecuritySchemeRequestBean;
