...
public class JiraExpressionsComplexityBeanExpensiveOperations {
    ...
    /**
     * Constructs a validated instance of {@link JiraExpressionsComplexityBeanExpensiveOperations}.
     *
     ...
     * Constructs a validated instance of {@link JiraExpressionsComplexityBeanExpensiveOperations}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #JiraExpressionsComplexityBeanExpensiveOperations(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public JiraExpressionsComplexityBeanExpensiveOperations(Integer limit, Integer value) {
        this.limit = limit;
        this.value = value;
    }
