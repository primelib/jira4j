...
@JsonTypeName("PageBeanSecurityLevel")
...
public class PageBeanSecurityLevel {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanSecurityLevel}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanSecurityLevel}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanSecurityLevel(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanSecurityLevel(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<SecurityLevel> values) {
        this.isLast = isLast;
