...
public class SearchRequestBean {
    ...
    public enum ValidateQueryEnum {
        ...
        private static final ValidateQueryEnum[] VALUES = values(); // prevent allocating a new array for every call to values()
        private final String value;

        @JsonCreator
        public static ValidateQueryEnum of(String input) {
            if (input != null) {
                for (ValidateQueryEnum v : VALUES) {
