...
@JsonTypeName("PageBeanSecurityLevelMember")
...
public class PageBeanSecurityLevelMember {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanSecurityLevelMember}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanSecurityLevelMember}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanSecurityLevelMember(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanSecurityLevelMember(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<SecurityLevelMember> values) {
        this.isLast = isLast;
