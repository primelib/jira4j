 ...
 * RemoveUserSpec
 * <p>
 * Specification for the RemoveUser operation.
 * <p>
 * Delete user
 */
@Getter
...
public class RemoveUserOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link RemoveUserOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public RemoveUserOperationSpec(Consumer<RemoveUserOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public RemoveUserOperationSpec(String accountId, String username, String key) {
