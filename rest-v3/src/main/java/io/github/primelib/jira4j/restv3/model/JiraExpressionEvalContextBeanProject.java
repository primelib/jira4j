...
public class JiraExpressionEvalContextBeanProject {
    ...
    /**
     * Constructs a validated instance of {@link JiraExpressionEvalContextBeanProject}.
     *
     ...
     * Constructs a validated instance of {@link JiraExpressionEvalContextBeanProject}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #JiraExpressionEvalContextBeanProject(Consumer)} instead.
     * @param id The ID of the referenced item.
     * @param key The key of the referenced item.
     */
    @ApiStatus.Internal
    public JiraExpressionEvalContextBeanProject(Long id, String key) {
        this.id = id;
        this.key = key;
    }
