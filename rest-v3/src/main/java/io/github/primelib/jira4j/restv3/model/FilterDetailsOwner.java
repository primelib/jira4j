...
public class FilterDetailsOwner {
    ...
    /**
     * Constructs a validated instance of {@link FilterDetailsOwner}.
     *
     * @param spec the specification to process
     */
    public FilterDetailsOwner(Consumer<FilterDetailsOwner> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link FilterDetailsOwner}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #FilterDetailsOwner(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public FilterDetailsOwner(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
