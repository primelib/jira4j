...
public class ComponentWithIssueCountRealAssignee {
    ...
    /**
     * Constructs a validated instance of {@link ComponentWithIssueCountRealAssignee}.
     *
     ...
     * Constructs a validated instance of {@link ComponentWithIssueCountRealAssignee}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ComponentWithIssueCountRealAssignee(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ComponentWithIssueCountRealAssignee(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
