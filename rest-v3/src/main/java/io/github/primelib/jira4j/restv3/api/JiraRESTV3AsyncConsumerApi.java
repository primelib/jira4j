...
public class JiraRESTV3AsyncConsumerApi {
    private final JiraRESTV3AsyncApi api;

    public JiraRESTV3AsyncConsumerApi(JiraRESTV3AsyncApi api) {
        this.api = api;
    }
     ...
     * </ul>
     */
    public CompletableFuture<PageOfCreateMetaIssueTypes> getCreateIssueMetaIssueTypes(Consumer<GetCreateIssueMetaIssueTypesOperationSpec> spec) {
