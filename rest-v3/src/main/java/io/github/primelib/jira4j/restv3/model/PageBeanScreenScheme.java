...
public class PageBeanScreenScheme {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanScreenScheme}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanScreenScheme}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanScreenScheme(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanScreenScheme(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<ScreenScheme> values) {
        this.isLast = isLast;
