...
public class PageBeanComment {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanComment}.
     *
     * @param spec the specification to process
     */
    public PageBeanComment(Consumer<PageBeanComment> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link PageBeanComment}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanComment(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanComment(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<Comment> values) {
        this.isLast = isLast;
