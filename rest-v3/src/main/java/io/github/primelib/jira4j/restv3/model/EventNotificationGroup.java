...
public class EventNotificationGroup {
    ...
    /**
     * Constructs a validated instance of {@link EventNotificationGroup}.
     *
     ...
     * Constructs a validated instance of {@link EventNotificationGroup}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #EventNotificationGroup(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public EventNotificationGroup(String groupId, String name, URI self) {
