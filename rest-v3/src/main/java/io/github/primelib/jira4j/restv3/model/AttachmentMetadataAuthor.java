...
public class AttachmentMetadataAuthor {
    ...
    /**
     * Constructs a validated instance of {@link AttachmentMetadataAuthor}.
     *
     * @param spec the specification to process
     */
    public AttachmentMetadataAuthor(Consumer<AttachmentMetadataAuthor> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AttachmentMetadataAuthor}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AttachmentMetadataAuthor(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public AttachmentMetadataAuthor(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
