...
public class UpdateWorkflowTransitionPropertyOperationSpec {
    ...
    /**
     * The key of the property being updated, also known as the name of the property. Set this to the same value as the {@code key} defined in the request body.
     */
    @NotNull 
    private String key;
    ...
    /**
     * Constructs a validated instance of {@link UpdateWorkflowTransitionPropertyOperationSpec}.
     *
     ...
     * @param key                  The key of the property being updated, also known as the name of the property. Set this to the same value as the {@code key} defined in the request body.
     ...
     */
    @ApiStatus.Internal
    public UpdateWorkflowTransitionPropertyOperationSpec(Long transitionId, String key, String workflowName, WorkflowTransitionProperty workflowTransitionProperty, String workflowMode) {
