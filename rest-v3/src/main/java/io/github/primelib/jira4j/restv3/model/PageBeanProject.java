...
public class PageBeanProject {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanProject}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanProject}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanProject(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanProject(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<Project> values) {
        this.isLast = isLast;
