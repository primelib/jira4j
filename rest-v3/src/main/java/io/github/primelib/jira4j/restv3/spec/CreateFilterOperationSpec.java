 ...
 * CreateFilterSpec
 * <p>
 * Specification for the CreateFilter operation.
 * <p>
 * Create filter
 */
@Getter
...
public class CreateFilterOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link CreateFilterOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateFilterOperationSpec(Consumer<CreateFilterOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public CreateFilterOperationSpec(Filter filter, String expand, Boolean overrideSharePermissions) {
        this.filter = filter;
        this.expand = expand;
