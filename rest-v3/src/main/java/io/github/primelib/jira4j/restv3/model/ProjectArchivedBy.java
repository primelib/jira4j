...
public class ProjectArchivedBy {
    ...
    /**
     * Constructs a validated instance of {@link ProjectArchivedBy}.
     *
     * @param spec the specification to process
     */
    public ProjectArchivedBy(Consumer<ProjectArchivedBy> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ProjectArchivedBy}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ProjectArchivedBy(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ProjectArchivedBy(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
