...
public class ProjectComponentAssignee {
    ...
    /**
     * Constructs a validated instance of {@link ProjectComponentAssignee}.
     *
     * @param spec the specification to process
     */
    public ProjectComponentAssignee(Consumer<ProjectComponentAssignee> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ProjectComponentAssignee}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ProjectComponentAssignee(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ProjectComponentAssignee(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
