...
public class FieldsStatus {
     ...
     */
    @ApiStatus.Internal
    public FieldsStatus(String description, String iconUrl, String id, String name, StatusDetailsScope scope, String self, StatusDetailsStatusCategory statusCategory) {
