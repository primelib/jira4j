...
public class MigrationResourceUpdateEntityPropertiesValuePutOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link MigrationResourceUpdateEntityPropertiesValuePutOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public MigrationResourceUpdateEntityPropertiesValuePutOperationSpec(UUID atlassianTransferId, String entityType, List<EntityPropertyDetails> entityPropertyDetails) {
