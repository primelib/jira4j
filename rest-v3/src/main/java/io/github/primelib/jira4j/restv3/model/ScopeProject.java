...
public class ScopeProject {
     ...
     */
    @ApiStatus.Internal
    public ScopeProject(ProjectAvatarUrls avatarUrls, String id, String key, String name, ProjectDetailsProjectCategory projectCategory, ProjectTypeKeyEnum projectTypeKey, String self, Boolean simplified) {
