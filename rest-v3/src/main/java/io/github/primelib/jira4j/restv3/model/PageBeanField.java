...
public class PageBeanField {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanField}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanField}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanField(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanField(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<Field> values) {
        this.isLast = isLast;
