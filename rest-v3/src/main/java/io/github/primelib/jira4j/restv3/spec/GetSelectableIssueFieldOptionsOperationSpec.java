...
public class GetSelectableIssueFieldOptionsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetSelectableIssueFieldOptionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetSelectableIssueFieldOptionsOperationSpec(Consumer<GetSelectableIssueFieldOptionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetSelectableIssueFieldOptionsOperationSpec(String fieldKey, Long startAt, Integer maxResults, Long projectId) {
