...
@Slf4j
public class JiraRESTV3ProxySpec {
    /*
    ...
    /**
     * Constructs a validated implementation of {@link JiraRESTV3ProxySpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public JiraRESTV3ProxySpec(Consumer<JiraRESTV3ProxySpec> spec) {
        spec.accept(this);
        validate();
    }
