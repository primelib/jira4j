...
public class UpdateScreenSchemeDetailsScreens {
    ...
    /**
     * Constructs a validated instance of {@link UpdateScreenSchemeDetailsScreens}.
     *
     ...
     * Constructs a validated instance of {@link UpdateScreenSchemeDetailsScreens}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #UpdateScreenSchemeDetailsScreens(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public UpdateScreenSchemeDetailsScreens(String create, String _default, String edit, String view) {
        this.create = create;
