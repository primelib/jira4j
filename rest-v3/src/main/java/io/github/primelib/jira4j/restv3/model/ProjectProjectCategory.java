...
public class ProjectProjectCategory {
    ...
    /**
     * Constructs a validated instance of {@link ProjectProjectCategory}.
     *
     ...
     * Constructs a validated instance of {@link ProjectProjectCategory}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ProjectProjectCategory(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ProjectProjectCategory(String description, String id, String name, URI self) {
