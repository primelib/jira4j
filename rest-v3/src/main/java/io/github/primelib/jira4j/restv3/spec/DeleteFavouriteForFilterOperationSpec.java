...
/**
 * DeleteFavouriteForFilterSpec
 * <p>
 * Specification for the DeleteFavouriteForFilter operation.
 * <p>
...
public class DeleteFavouriteForFilterOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link DeleteFavouriteForFilterOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteFavouriteForFilterOperationSpec(Consumer<DeleteFavouriteForFilterOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteFavouriteForFilterOperationSpec(Long id, String expand) {
        this.id = id;
        this.expand = expand;
