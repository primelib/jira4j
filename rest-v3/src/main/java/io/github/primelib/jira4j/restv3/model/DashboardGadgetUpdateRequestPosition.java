...
@JsonTypeName("DashboardGadgetUpdateRequest_position")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class DashboardGadgetUpdateRequestPosition {

    /**
     * Constructs a validated implementation of {@link DashboardGadgetUpdateRequestPosition}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DashboardGadgetUpdateRequestPosition(Consumer<DashboardGadgetUpdateRequestPosition> spec) {
        spec.accept(this);
    }
