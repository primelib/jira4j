...
public class PageBeanWorkflowScheme {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanWorkflowScheme}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanWorkflowScheme}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanWorkflowScheme(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanWorkflowScheme(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<WorkflowScheme> values) {
        this.isLast = isLast;
