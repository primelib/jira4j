...
public class JiraExpressionEvalContextBeanIssue {
    ...
    /**
     * Constructs a validated instance of {@link JiraExpressionEvalContextBeanIssue}.
     *
     ...
     * Constructs a validated instance of {@link JiraExpressionEvalContextBeanIssue}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #JiraExpressionEvalContextBeanIssue(Consumer)} instead.
     * @param id The ID of the referenced item.
     * @param key The key of the referenced item.
     */
    @ApiStatus.Internal
    public JiraExpressionEvalContextBeanIssue(Long id, String key) {
        this.id = id;
        this.key = key;
    }
