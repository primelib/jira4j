...
public class PageBeanScreen {
     ...
     */
    @JsonProperty("values")
    protected List<Screen> values;

    /**
     * Constructs a validated instance of {@link PageBeanScreen}.
     *
     * @param spec the specification to process
     */
    public PageBeanScreen(Consumer<PageBeanScreen> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link PageBeanScreen}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanScreen(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanScreen(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<Screen> values) {
        this.isLast = isLast;
