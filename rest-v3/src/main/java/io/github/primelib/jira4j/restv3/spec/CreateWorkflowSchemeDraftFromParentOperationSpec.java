...
public class CreateWorkflowSchemeDraftFromParentOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link CreateWorkflowSchemeDraftFromParentOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public CreateWorkflowSchemeDraftFromParentOperationSpec(Long id) {
        this.id = id;
