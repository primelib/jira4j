...
public interface JiraRESTV3AsyncApi {
    ...
    CompletableFuture<ProjectRole> addActorUsers(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("id") @NotNull Long id, @NotNull ActorsMap actorsMap);
    ...
    CompletableFuture<List<Attachment>> addAttachment(@Param("issueIdOrKey") @NotNull String issueIdOrKey);
    ...
    CompletableFuture<Comment> addComment(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull Comment comment, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<Object> addFieldToDefaultScreen(@Param("fieldId") @NotNull String fieldId);
    ...
    CompletableFuture<DashboardGadget> addGadget(@Param("dashboardId") @NotNull Long dashboardId, @NotNull DashboardGadgetSettings dashboardGadgetSettings);
    ...
    CompletableFuture<Object> addIssueTypesToContext(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull IssueTypeIds issueTypeIds);
    ...
    CompletableFuture<Object> addIssueTypesToIssueTypeScheme(@Param("issueTypeSchemeId") @NotNull Long issueTypeSchemeId, @NotNull IssueTypeIds issueTypeIds);
    ...
    CompletableFuture<Object> addNotifications(@Param("id") @NotNull String id, @NotNull AddNotificationsDetails addNotificationsDetails);
    ...
    CompletableFuture<ProjectRole> addProjectRoleActorsToRole(@Param("id") @NotNull Long id, @NotNull ActorInputBean actorInputBean);
    ...
    CompletableFuture<ScreenableTab> addScreenTab(@Param("screenId") @NotNull Long screenId, @NotNull ScreenableTab screenableTab);
    ...
    CompletableFuture<ScreenableField> addScreenTabField(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId, @NotNull AddFieldBean addFieldBean);
    ...
    CompletableFuture<Object> addSecurityLevel(@Param("schemeId") @NotNull String schemeId, @NotNull AddSecuritySchemeLevelsRequestBean addSecuritySchemeLevelsRequestBean);
    ...
    CompletableFuture<Object> addSecurityLevelMembers(@Param("schemeId") @NotNull String schemeId, @Param("levelId") @NotNull String levelId, @NotNull SecuritySchemeMembersRequest securitySchemeMembersRequest);
    ...
    CompletableFuture<List<SharePermission>> addSharePermission(@Param("id") @NotNull Long id, @NotNull SharePermissionInputBean sharePermissionInputBean);
    ...
    CompletableFuture<Group> addUserToGroup(@NotNull UpdateUserToGroupBean updateUserToGroupBean, @Param("groupname") @Nullable String groupname, @Param("groupId") @Nullable String groupId);
    ...
    CompletableFuture<Object> addVote(@Param("issueIdOrKey") @NotNull String issueIdOrKey);
    ...
    CompletableFuture<Object> addWatcher(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull String body);
    ...
    CompletableFuture<Worklog> addWorklog(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull Worklog worklog, @Param("notifyUsers") @Nullable Boolean notifyUsers, @Param("adjustEstimate") @Nullable String adjustEstimate, @Param("newEstimate") @Nullable String newEstimate, @Param("reduceBy") @Nullable String reduceBy, @Param("expand") @Nullable String expand, @Param("overrideEditableFlag") @Nullable Boolean overrideEditableFlag);
    ...
    CompletableFuture<Void> addonPropertiesResourceDeleteAddonPropertyDelete(@Param("addonKey") @NotNull String addonKey, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<Void> addonPropertiesResourceDeleteAppPropertyDelete(@Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<PropertyKeys> addonPropertiesResourceGetAddonPropertiesGet(@Param("addonKey") @NotNull String addonKey);
    ...
    CompletableFuture<EntityProperty> addonPropertiesResourceGetAddonPropertyGet(@Param("addonKey") @NotNull String addonKey, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<OperationMessage> addonPropertiesResourcePutAddonPropertyPut(@Param("addonKey") @NotNull String addonKey, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
    ...
    CompletableFuture<OperationMessage> addonPropertiesResourcePutAppPropertyPut(@Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
    ...
    CompletableFuture<JiraExpressionsAnalysis> analyseExpression(@NotNull JiraExpressionForAnalysis jiraExpressionForAnalysis, @Param("check") @Nullable String check);
    ...
    CompletableFuture<Object> archiveProject(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<Object> assignFieldConfigurationSchemeToProject(@NotNull FieldConfigurationSchemeProjectAssociation fieldConfigurationSchemeProjectAssociation);
    ...
    CompletableFuture<Object> assignIssue(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull User user);
    ...
    CompletableFuture<Object> assignIssueTypeSchemeToProject(@NotNull IssueTypeSchemeProjectAssociation issueTypeSchemeProjectAssociation);
    ...
    CompletableFuture<Object> assignIssueTypeScreenSchemeToProject(@NotNull IssueTypeScreenSchemeProjectAssociation issueTypeScreenSchemeProjectAssociation);
    ...
    CompletableFuture<PermissionScheme> assignPermissionScheme(@Param("projectKeyOrId") @NotNull String projectKeyOrId, @NotNull IdBean idBean, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<Object> assignProjectsToCustomFieldContext(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull ProjectIds projectIds);
    ...
    CompletableFuture<Object> assignSchemeToProject(@NotNull WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation);
    ...
    CompletableFuture<Void> associateSchemesToProjects(@NotNull AssociateSecuritySchemeWithProjectDetails associateSecuritySchemeWithProjectDetails);
    ...
    CompletableFuture<Void> bulkDeleteIssueProperty(@Param("propertyKey") @NotNull String propertyKey, @NotNull IssueFilterForBulkPropertyDelete issueFilterForBulkPropertyDelete);
    ...
    CompletableFuture<BulkEditShareableEntityResponse> bulkEditDashboards(@NotNull BulkEditShareableEntityRequest bulkEditShareableEntityRequest);
    ...
    CompletableFuture<PageBeanGroupDetails> bulkGetGroups(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("groupId") @Nullable Set<String> groupId, @Param("groupName") @Nullable Set<String> groupName, @Param("accessType") @Nullable String accessType, @Param("applicationKey") @Nullable String applicationKey);
    ...
    CompletableFuture<PageBeanUser> bulkGetUsers(@Param("accountId") @NotNull List<String> accountId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("username") @Nullable List<String> username, @Param("key") @Nullable List<String> key);
    ...
    CompletableFuture<List<UserMigrationBean>> bulkGetUsersMigration(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("username") @Nullable List<String> username, @Param("key") @Nullable List<String> key);
    ...
    CompletableFuture<Void> bulkSetIssuePropertiesByIssue(@NotNull MultiIssueEntityProperties multiIssueEntityProperties);
    ...
    CompletableFuture<Void> bulkSetIssueProperty(@Param("propertyKey") @NotNull String propertyKey, @NotNull BulkIssuePropertyUpdateRequest bulkIssuePropertyUpdateRequest);
    ...
    CompletableFuture<Void> bulkSetIssuesPropertiesList(@NotNull IssueEntityProperties issueEntityProperties);
    ...
    CompletableFuture<Object> cancelTask(@Param("taskId") @NotNull String taskId);
    ...
    CompletableFuture<Object> changeFilterOwner(@Param("id") @NotNull Long id, @NotNull ChangeFilterOwner changeFilterOwner);
    ...
    CompletableFuture<Dashboard> copyDashboard(@Param("id") @NotNull String id, @NotNull DashboardDetails dashboardDetails);
    ...
    CompletableFuture<ProjectComponent> createComponent(@NotNull ProjectComponent projectComponent);
    ...
    CompletableFuture<FieldDetails> createCustomField(@NotNull CustomFieldDefinitionJsonBean customFieldDefinitionJsonBean);
    ...
    CompletableFuture<CreateCustomFieldContext> createCustomFieldContext(@Param("fieldId") @NotNull String fieldId, @NotNull CreateCustomFieldContext createCustomFieldContext);
    ...
    CompletableFuture<CustomFieldCreatedContextOptionsList> createCustomFieldOption(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull BulkCustomFieldOptionCreateRequest bulkCustomFieldOptionCreateRequest);
    ...
    CompletableFuture<Dashboard> createDashboard(@NotNull DashboardDetails dashboardDetails);
    ...
    CompletableFuture<FieldConfiguration> createFieldConfiguration(@NotNull FieldConfigurationDetails fieldConfigurationDetails);
    ...
    CompletableFuture<FieldConfigurationScheme> createFieldConfigurationScheme(@NotNull UpdateFieldConfigurationSchemeDetails updateFieldConfigurationSchemeDetails);
    ...
    CompletableFuture<Filter> createFilter(@NotNull Filter filter, @Param("expand") @Nullable String expand, @Param("overrideSharePermissions") @Nullable Boolean overrideSharePermissions);
    ...
    CompletableFuture<Group> createGroup(@NotNull AddGroupBean addGroupBean);
    ...
    CompletableFuture<CreatedIssue> createIssue(@NotNull IssueUpdateDetails issueUpdateDetails, @Param("updateHistory") @Nullable Boolean updateHistory);
    ...
    CompletableFuture<IssueFieldOption> createIssueFieldOption(@Param("fieldKey") @NotNull String fieldKey, @NotNull IssueFieldOptionCreateBean issueFieldOptionCreateBean);
    ...
    CompletableFuture<IssueLinkType> createIssueLinkType(@NotNull IssueLinkType issueLinkType);
    ...
    CompletableFuture<SecuritySchemeId> createIssueSecurityScheme(@NotNull CreateIssueSecuritySchemeDetails createIssueSecuritySchemeDetails);
    ...
    CompletableFuture<IssueTypeDetails> createIssueType(@NotNull IssueTypeCreateBean issueTypeCreateBean);
     ...
     * For example:
     *  {@code curl --request POST \\ --user email@example.com:&amp;lt;api_token&amp;gt; \\ --header 'X-Atlassian-Token: no-check' \\ --header 'Content-Type: image/&amp;lt; image_type&amp;gt;' \\ --data-binary "&amp;lt;@/path/to/file/with/your/avatar&amp;gt;" \\ --url 'https://your-domain.atlassian.net/rest/api/3/issuetype/{issueTypeId}'This}
    ...
    CompletableFuture<Avatar> createIssueTypeAvatar(@Param("id") @NotNull String id, @Param("size") @NotNull Integer size, @NotNull Object body, @Param("x") @Nullable Integer x, @Param("y") @Nullable Integer y);
    ...
    CompletableFuture<IssueTypeSchemeID> createIssueTypeScheme(@NotNull IssueTypeSchemeDetails issueTypeSchemeDetails);
    ...
    CompletableFuture<IssueTypeScreenSchemeId> createIssueTypeScreenScheme(@NotNull IssueTypeScreenSchemeDetails issueTypeScreenSchemeDetails);
    ...
    CompletableFuture<CreatedIssues> createIssues(@NotNull IssuesUpdateBean issuesUpdateBean);
    ...
    CompletableFuture<NotificationSchemeId> createNotificationScheme(@NotNull CreateNotificationSchemeDetails createNotificationSchemeDetails);
    ...
    CompletableFuture<RemoteIssueLinkIdentifies> createOrUpdateRemoteIssueLink(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull RemoteIssueLinkRequest remoteIssueLinkRequest);
    ...
    CompletableFuture<PermissionGrant> createPermissionGrant(@Param("schemeId") @NotNull Long schemeId, @NotNull PermissionGrant permissionGrant, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PermissionScheme> createPermissionScheme(@NotNull PermissionScheme permissionScheme, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PriorityId> createPriority(@NotNull CreatePriorityDetails createPriorityDetails);
    ...
    CompletableFuture<ProjectIdentifiers> createProject(@NotNull CreateProjectDetails createProjectDetails);
    ...
    CompletableFuture<Avatar> createProjectAvatar(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @NotNull Object body, @Param("x") @Nullable Integer x, @Param("y") @Nullable Integer y, @Param("size") @Nullable Integer size);
    ...
    CompletableFuture<ProjectCategory> createProjectCategory(@NotNull ProjectCategory projectCategory);
    ...
    CompletableFuture<ProjectRole> createProjectRole(@NotNull CreateUpdateRoleRequestBean createUpdateRoleRequestBean);
    ...
    CompletableFuture<VersionRelatedWork> createRelatedWork(@Param("id") @NotNull String id, @NotNull VersionRelatedWork versionRelatedWork);
    ...
    CompletableFuture<ResolutionId> createResolution(@NotNull CreateResolutionDetails createResolutionDetails);
    ...
    CompletableFuture<Screen> createScreen(@NotNull ScreenDetails screenDetails);
    ...
    CompletableFuture<ScreenSchemeId> createScreenScheme(@NotNull ScreenSchemeDetails screenSchemeDetails);
    ...
    CompletableFuture<List<JiraStatus>> createStatuses(@NotNull StatusCreateRequest statusCreateRequest);
    ...
    CompletableFuture<UiModificationIdentifiers> createUiModification(@NotNull CreateUiModificationDetails createUiModificationDetails);
    ...
    CompletableFuture<User> createUser(@NotNull NewUserDetails newUserDetails);
    ...
    CompletableFuture<Version> createVersion(@NotNull Version version);
    ...
    CompletableFuture<WorkflowIDs> createWorkflow(@NotNull CreateWorkflowDetails createWorkflowDetails);
    ...
    CompletableFuture<WorkflowScheme> createWorkflowScheme(@NotNull WorkflowScheme workflowScheme);
    ...
    CompletableFuture<WorkflowScheme> createWorkflowSchemeDraftFromParent(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<WorkflowTransitionProperty> createWorkflowTransitionProperty(@Param("transitionId") @NotNull Long transitionId, @Param("key") @NotNull String key, @Param("workflowName") @NotNull String workflowName, @NotNull WorkflowTransitionProperty workflowTransitionProperty, @Param("workflowMode") @Nullable String workflowMode);
    ...
    CompletableFuture<WorkflowCreateResponse> createWorkflows(@NotNull WorkflowCreateRequest workflowCreateRequest);
    ...
    CompletableFuture<Void> deleteActor(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("id") @NotNull Long id, @Param("user") @Nullable String user, @Param("group") @Nullable String group, @Param("groupId") @Nullable String groupId);
    ...
    CompletableFuture<Object> deleteAndReplaceVersion(@Param("id") @NotNull String id, @NotNull DeleteAndReplaceVersionBean deleteAndReplaceVersionBean);
    ...
    CompletableFuture<Void> deleteAvatar(@Param("type") @NotNull String type, @Param("owningObjectId") @NotNull String owningObjectId, @Param("id") @NotNull Long id);
    ...
    CompletableFuture<Void> deleteComment(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("id") @NotNull String id);
    ...
    CompletableFuture<Void> deleteCommentProperty(@Param("commentId") @NotNull String commentId, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<Void> deleteComponent(@Param("id") @NotNull String id, @Param("moveIssuesTo") @Nullable String moveIssuesTo);
    ...
    CompletableFuture<Void> deleteCustomField(@Param("id") @NotNull String id);
    ...
    CompletableFuture<Object> deleteCustomFieldContext(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId);
    ...
    CompletableFuture<Void> deleteCustomFieldOption(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @Param("optionId") @NotNull Long optionId);
    ...
    CompletableFuture<Void> deleteDashboard(@Param("id") @NotNull String id);
    ...
    CompletableFuture<WorkflowScheme> deleteDefaultWorkflow(@Param("id") @NotNull Long id, @Param("updateDraftIfNeeded") @Nullable Boolean updateDraftIfNeeded);
    ...
    CompletableFuture<WorkflowScheme> deleteDraftDefaultWorkflow(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<Void> deleteDraftWorkflowMapping(@Param("id") @NotNull Long id, @Param("workflowName") @NotNull String workflowName);
    ...
    CompletableFuture<Filter> deleteFavouriteForFilter(@Param("id") @NotNull Long id, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<Object> deleteFieldConfiguration(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<Object> deleteFieldConfigurationScheme(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<Void> deleteFilter(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<Void> deleteInactiveWorkflow(@Param("entityId") @NotNull String entityId);
    ...
    CompletableFuture<Void> deleteIssue(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("deleteSubtasks") @Nullable String deleteSubtasks);
    ...
    CompletableFuture<Object> deleteIssueFieldOption(@Param("fieldKey") @NotNull String fieldKey, @Param("optionId") @NotNull Long optionId);
    ...
    CompletableFuture<Void> deleteIssueLink(@Param("linkId") @NotNull String linkId);
    ...
    CompletableFuture<Void> deleteIssueLinkType(@Param("issueLinkTypeId") @NotNull String issueLinkTypeId);
    ...
    CompletableFuture<Void> deleteIssueProperty(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<Void> deleteIssueType(@Param("id") @NotNull String id, @Param("alternativeIssueTypeId") @Nullable String alternativeIssueTypeId);
    ...
    CompletableFuture<Void> deleteIssueTypeProperty(@Param("issueTypeId") @NotNull String issueTypeId, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<Object> deleteIssueTypeScheme(@Param("issueTypeSchemeId") @NotNull Long issueTypeSchemeId);
    ...
    CompletableFuture<Object> deleteIssueTypeScreenScheme(@Param("issueTypeScreenSchemeId") @NotNull String issueTypeScreenSchemeId);
    ...
    CompletableFuture<Object> deleteLocale();
    ...
    CompletableFuture<Object> deleteNotificationScheme(@Param("notificationSchemeId") @NotNull String notificationSchemeId);
    ...
    CompletableFuture<Void> deletePermissionScheme(@Param("schemeId") @NotNull Long schemeId);
    ...
    CompletableFuture<Void> deletePermissionSchemeEntity(@Param("schemeId") @NotNull Long schemeId, @Param("permissionId") @NotNull Long permissionId);
    ...
    CompletableFuture<Void> deletePriority(@Param("id") @NotNull String id, @Param("replaceWith") @NotNull String replaceWith);
    ...
    CompletableFuture<Void> deleteProject(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("enableUndo") @Nullable Boolean enableUndo);
    ...
    CompletableFuture<Void> deleteProjectAsynchronously(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<Void> deleteProjectAvatar(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("id") @NotNull Long id);
    ...
    CompletableFuture<Void> deleteProjectProperty(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<Void> deleteProjectRole(@Param("id") @NotNull Long id, @Param("swap") @Nullable Long swap);
    ...
    CompletableFuture<ProjectRole> deleteProjectRoleActorsFromRole(@Param("id") @NotNull Long id, @Param("user") @Nullable String user, @Param("groupId") @Nullable String groupId, @Param("group") @Nullable String group);
    ...
    CompletableFuture<Void> deleteRelatedWork(@Param("versionId") @NotNull String versionId, @Param("relatedWorkId") @NotNull String relatedWorkId);
    ...
    CompletableFuture<Void> deleteRemoteIssueLinkByGlobalId(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("globalId") @NotNull String globalId);
    ...
    CompletableFuture<Void> deleteRemoteIssueLinkById(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("linkId") @NotNull String linkId);
    ...
    CompletableFuture<Void> deleteResolution(@Param("id") @NotNull String id, @Param("replaceWith") @NotNull String replaceWith);
    ...
    CompletableFuture<Void> deleteScreen(@Param("screenId") @NotNull Long screenId);
    ...
    CompletableFuture<Void> deleteScreenScheme(@Param("screenSchemeId") @NotNull String screenSchemeId);
    ...
    CompletableFuture<Void> deleteScreenTab(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId);
    ...
    CompletableFuture<Object> deleteSecurityScheme(@Param("schemeId") @NotNull String schemeId);
    ...
    CompletableFuture<Void> deleteSharePermission(@Param("id") @NotNull Long id, @Param("permissionId") @NotNull Long permissionId);
    ...
    CompletableFuture<Object> deleteUiModification(@Param("uiModificationId") @NotNull String uiModificationId);
    ...
    CompletableFuture<Void> deleteUserProperty(@Param("propertyKey") @NotNull String propertyKey, @Param("accountId") @Nullable String accountId, @Param("userKey") @Nullable String userKey, @Param("username") @Nullable String username);
    ...
    CompletableFuture<Void> deleteVersion(@Param("id") @NotNull String id, @Param("moveFixIssuesTo") @Nullable String moveFixIssuesTo, @Param("moveAffectedIssuesTo") @Nullable String moveAffectedIssuesTo);
    ...
    CompletableFuture<Void> deleteWebhookById(@NotNull ContainerForWebhookIDs containerForWebhookIDs);
    ...
    CompletableFuture<Void> deleteWorkflowMapping(@Param("id") @NotNull Long id, @Param("workflowName") @NotNull String workflowName, @Param("updateDraftIfNeeded") @Nullable Boolean updateDraftIfNeeded);
    ...
    CompletableFuture<Object> deleteWorkflowScheme(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<Void> deleteWorkflowSchemeDraft(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<WorkflowScheme> deleteWorkflowSchemeDraftIssueType(@Param("id") @NotNull Long id, @Param("issueType") @NotNull String issueType);
    ...
    CompletableFuture<WorkflowScheme> deleteWorkflowSchemeIssueType(@Param("id") @NotNull Long id, @Param("issueType") @NotNull String issueType, @Param("updateDraftIfNeeded") @Nullable Boolean updateDraftIfNeeded);
    ...
    CompletableFuture<Void> deleteWorkflowTransitionProperty(@Param("transitionId") @NotNull Long transitionId, @Param("key") @NotNull String key, @Param("workflowName") @NotNull String workflowName, @Param("workflowMode") @Nullable String workflowMode);
    ...
    CompletableFuture<WorkflowTransitionRulesUpdateErrors> deleteWorkflowTransitionRuleConfigurations(@NotNull WorkflowsWithTransitionRulesDetails workflowsWithTransitionRulesDetails);
    ...
    CompletableFuture<Void> deleteWorklog(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("id") @NotNull String id, @Param("notifyUsers") @Nullable Boolean notifyUsers, @Param("adjustEstimate") @Nullable String adjustEstimate, @Param("newEstimate") @Nullable String newEstimate, @Param("increaseBy") @Nullable String increaseBy, @Param("overrideEditableFlag") @Nullable Boolean overrideEditableFlag);
    ...
    CompletableFuture<Void> deleteWorklogProperty(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("worklogId") @NotNull String worklogId, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<Object> doTransition(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull IssueUpdateDetails issueUpdateDetails);
    ...
    CompletableFuture<ConnectModules> dynamicModulesResourceGetModulesGet();
    ...
    CompletableFuture<Void> dynamicModulesResourceRegisterModulesPost(@NotNull ConnectModules connectModules);
    ...
    CompletableFuture<Void> dynamicModulesResourceRemoveModulesDelete(@Param("moduleKey") @Nullable List<String> moduleKey);
    ...
    CompletableFuture<JiraExpressionResult> evaluateJiraExpression(@NotNull JiraExpressionEvalRequestBean jiraExpressionEvalRequestBean, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<AttachmentArchiveMetadataReadable> expandAttachmentForHumans(@Param("id") @NotNull String id);
    ...
    CompletableFuture<List<User>> findBulkAssignableUsers(@Param("projectKeys") @NotNull String projectKeys, @Param("query") @Nullable String query, @Param("username") @Nullable String username, @Param("accountId") @Nullable String accountId, @Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<List<User>> findUsers(@Param("query") @Nullable String query, @Param("username") @Nullable String username, @Param("accountId") @Nullable String accountId, @Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("property") @Nullable String property);
    ...
    CompletableFuture<FoundUsersAndGroups> findUsersAndGroups(@Param("query") @NotNull String query, @Param("maxResults") @Nullable Integer maxResults, @Param("showAvatar") @Nullable Boolean showAvatar, @Param("fieldId") @Nullable String fieldId, @Param("projectId") @Nullable List<String> projectId, @Param("issueTypeId") @Nullable List<String> issueTypeId, @Param("avatarSize") @Nullable String avatarSize, @Param("caseInsensitive") @Nullable Boolean caseInsensitive, @Param("excludeConnectAddons") @Nullable Boolean excludeConnectAddons);
    ...
    CompletableFuture<PageBeanUser> findUsersByQuery(@Param("query") @NotNull String query, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<FoundUsers> findUsersForPicker(@Param("query") @NotNull String query, @Param("maxResults") @Nullable Integer maxResults, @Param("showAvatar") @Nullable Boolean showAvatar, @Param("exclude") @Nullable List<String> exclude, @Param("excludeAccountIds") @Nullable List<String> excludeAccountIds, @Param("avatarSize") @Nullable String avatarSize, @Param("excludeConnectUsers") @Nullable Boolean excludeConnectUsers);
    ...
    CompletableFuture<List<User>> findUsersWithBrowsePermission(@Param("query") @Nullable String query, @Param("username") @Nullable String username, @Param("accountId") @Nullable String accountId, @Param("issueKey") @Nullable String issueKey, @Param("projectKey") @Nullable String projectKey, @Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<ProjectRole> fullyUpdateProjectRole(@Param("id") @NotNull Long id, @NotNull CreateUpdateRoleRequestBean createUpdateRoleRequestBean);
    ...
    CompletableFuture<ProjectType> getAccessibleProjectTypeByKey(@Param("projectTypeKey") @NotNull String projectTypeKey);
    ...
    CompletableFuture<List<ApplicationProperty>> getAdvancedSettings();
    ...
    CompletableFuture<List<ProjectType>> getAllAccessibleProjectTypes();
    ...
    CompletableFuture<List<ApplicationRole>> getAllApplicationRoles();
    ...
    CompletableFuture<AvailableDashboardGadgetsResponse> getAllAvailableDashboardGadgets();
    ...
    CompletableFuture<PageOfDashboards> getAllDashboards(@Param("filter") @Nullable String filter, @Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageBeanFieldConfigurationDetails> getAllFieldConfigurations(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id, @Param("isDefault") @Nullable Boolean isDefault, @Param("query") @Nullable String query);
    ...
    CompletableFuture<PageBeanFieldConfigurationScheme> getAllFieldgRnfigurationSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id);
    ...
    CompletableFuture<DashboardGadgetResponse> getAllGadgets(@Param("dashboardId") @NotNull Long dashboardId, @Param("moduleKey") @Nullable List<String> moduleKey, @Param("uri") @Nullable List<String> uri, @Param("gadgetId") @Nullable List<Long> gadgetId);
    ...
    CompletableFuture<PageBeanIssueFieldOption> getAllIssueFieldOptions(@Param("fieldKey") @NotNull String fieldKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageBeanIssueTypeScheme> getAllIssueTypeSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id, @Param("orderBy") @Nullable String orderBy, @Param("expand") @Nullable String expand, @Param("queryString") @Nullable String queryString);
    ...
    CompletableFuture<PageBeanString> getAllLabels(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PermissionSchemes> getAllPermissionSchemes(@Param("expand") @Nullable String expand);
    ...
    CompletableFuture<Permissions> getAllPermissions();
    ...
    CompletableFuture<ProjectAvatars> getAllProjectAvatars(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<List<ProjectCategory>> getAllProjectCategories();
    ...
    CompletableFuture<List<ProjectRole>> getAllProjectRoles();
    ...
    CompletableFuture<List<ProjectType>> getAllProjectTypes();
    ...
    CompletableFuture<List<Project>> getAllProjects(@Param("expand") @Nullable String expand, @Param("recent") @Nullable Integer recent, @Param("properties") @Nullable List<String> properties);
    ...
    CompletableFuture<List<ScreenableField>> getAllScreenTabFields(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId, @Param("projectKey") @Nullable String projectKey);
    ...
    CompletableFuture<List<ScreenableTab>> getAllScreenTabs(@Param("screenId") @NotNull Long screenId, @Param("projectKey") @Nullable String projectKey);
    ...
    CompletableFuture<List<IssueTypeWithStatus>> getAllStatuses(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<SystemAvatars> getAllSystemAvatars(@Param("type") @NotNull String type);
    ...
    CompletableFuture<List<User>> getAllUsers(@Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<List<User>> getAllUsersDefault(@Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageBeanWorkflowScheme> getAllWorkflowSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<List<DeprecatedWorkflow>> getAllWorkflows(@Param("workflowName") @Nullable String workflowName);
    ...
    CompletableFuture<List<IssueTypeDetails>> getAlternativeIssueTypes(@Param("id") @NotNull String id);
    ...
    CompletableFuture<List<ApplicationProperty>> getApplicationProperty(@Param("key") @Nullable String key, @Param("permissionLevel") @Nullable String permissionLevel, @Param("keyFilter") @Nullable String keyFilter);
    ...
    CompletableFuture<ApplicationRole> getApplicationRole(@Param("key") @NotNull String key);
    ...
    CompletableFuture<LicenseMetric> getApproximateApplicationLicenseCount(@Param("applicationKey") @NotNull String applicationKey);
    ...
    CompletableFuture<LicenseMetric> getApproximateLicenseCount();
    ...
    CompletableFuture<PermissionScheme> getAssignedPermissionScheme(@Param("projectKeyOrId") @NotNull String projectKeyOrId, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<AttachmentMetadata> getAttachment(@Param("id") @NotNull String id);
    ...
    CompletableFuture<Object> getAttachmentContent(@Param("id") @NotNull String id, @Param("redirect") @Nullable Boolean redirect);
    ...
    CompletableFuture<AttachmentSettings> getAttachmentMeta();
    ...
    CompletableFuture<Object> getAttachmentThumbnail(@Param("id") @NotNull String id, @Param("redirect") @Nullable Boolean redirect, @Param("fallbackToDefault") @Nullable Boolean fallbackToDefault, @Param("width") @Nullable Integer width, @Param("height") @Nullable Integer height);
    ...
    CompletableFuture<JQLReferenceData> getAutoComplete();
    ...
    CompletableFuture<JQLReferenceData> getAutoCompletePost(@NotNull SearchAutoCompleteFilter searchAutoCompleteFilter);
    ...
    CompletableFuture<List<ScreenableField>> getAvailableScreenFields(@Param("screenId") @NotNull Long screenId);
    ...
    CompletableFuture<List<TimeTrackingProvider>> getAvailableTimeTrackingImplementations();
    ...
    CompletableFuture<Void> getAvatarImageByID(@Param("type") @NotNull String type, @Param("id") @NotNull Long id, @Param("size") @Nullable String size, @Param("format") @Nullable String format);
    ...
    CompletableFuture<Void> getAvatarImageByOwner(@Param("type") @NotNull String type, @Param("entityId") @NotNull String entityId, @Param("size") @Nullable String size, @Param("format") @Nullable String format);
    ...
    CompletableFuture<Void> getAvatarImageByType(@Param("type") @NotNull String type, @Param("size") @Nullable String size, @Param("format") @Nullable String format);
    ...
    CompletableFuture<Avatars> getAvatars(@Param("type") @NotNull String type, @Param("entityId") @NotNull String entityId);
    ...
    CompletableFuture<AnnouncementBannerConfiguration> getBanner();
    ...
    CompletableFuture<BulkPermissionGrants> getBulkPermissions(@NotNull BulkPermissionsRequestBean bulkPermissionsRequestBean);
    ...
    CompletableFuture<Void> getBulkScreenTabs(@Param("screenId") @Nullable Set<Long> screenId, @Param("tabId") @Nullable Set<Long> tabId, @Param("startAt") @Nullable Long startAt, @Param("maxResult") @Nullable Integer maxResult);
    ...
    CompletableFuture<PageBeanChangelog> getChangeLogs(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageOfChangelogs> getChangeLogsByIds(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull IssueChangelogIds issueChangelogIds);
    ...
    CompletableFuture<List<ColumnItem>> getColumns(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<Comment> getComment(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("id") @NotNull String id, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<EntityProperty> getCommentProperty(@Param("commentId") @NotNull String commentId, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<PropertyKeys> getCommentPropertyKeys(@Param("commentId") @NotNull String commentId);
    ...
    CompletableFuture<PageOfComments> getComments(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("orderBy") @Nullable String orderBy, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PageBeanComment> getCommentsByIds(@NotNull IssueCommentListRequestBean issueCommentListRequestBean, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<ProjectComponent> getComponent(@Param("id") @NotNull String id);
    ...
    CompletableFuture<ComponentIssuesCount> getComponentRelatedIssues(@Param("id") @NotNull String id);
    ...
    CompletableFuture<PageBeanContext> getContextsForFieldDeprecated(@Param("fieldId") @NotNull String fieldId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageOfCreateMetaIssueTypeWithField> getCreateIssueMetaIssueTypeId(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("issueTypeId") @NotNull String issueTypeId, @Param("startAt") @Nullable Integer startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<User> getCurrentUser(@Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PageBeanContextForProjectAndIssueType> getCustomFieldContextsForProjectsAndIssueTypes(@Param("fieldId") @NotNull String fieldId, @NotNull ProjectIssueTypeMappings projectIssueTypeMappings, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<CustomFieldOption> getCustomFieldOption(@Param("id") @NotNull String id);
    ...
    CompletableFuture<Dashboard> getDashboard(@Param("id") @NotNull String id);
    ...
    CompletableFuture<EntityProperty> getDashboardItemProperty(@Param("dashboardId") @NotNull String dashboardId, @Param("itemId") @NotNull String itemId, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<PropertyKeys> getDashboardItemPropertyKeys(@Param("dashboardId") @NotNull String dashboardId, @Param("itemId") @NotNull String itemId);
    ...
    CompletableFuture<DefaultShareScope> getDefaultShareScope();
    ...
    CompletableFuture<PageBeanCustomFieldContextDefaultValue> getDefaultValues(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @Nullable Set<Long> contextId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<DefaultWorkflow> getDefaultWorkflow(@Param("id") @NotNull Long id, @Param("returnDraftIfExists") @Nullable Boolean returnDraftIfExists);
    ...
    CompletableFuture<DefaultWorkflow> getDraftDefaultWorkflow(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<IssueTypesWorkflowMapping> getDraftWorkflow(@Param("id") @NotNull Long id, @Param("workflowName") @Nullable String workflowName);
    ...
    CompletableFuture<PageBeanWebhook> getDynamicWebhooksForApp(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<IssueUpdateMetadata> getEditIssueMeta(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("overrideScreenSecurity") @Nullable Boolean overrideScreenSecurity, @Param("overrideEditableFlag") @Nullable Boolean overrideEditableFlag);
    ...
    CompletableFuture<List<IssueEvent>> getEvents();
    ...
    CompletableFuture<FailedWebhooks> getFailedWebhooks(@Param("maxResults") @Nullable Integer maxResults, @Param("after") @Nullable Long after);
    ...
    CompletableFuture<List<Filter>> getFavouriteFilters(@Param("expand") @Nullable String expand);
    ...
    CompletableFuture<ContainerForProjectFeatures> getFeaturesForProject(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<AutoCompleteSuggestions> getFieldAutoCompleteForQueryString(@Param("fieldName") @Nullable String fieldName, @Param("fieldValue") @Nullable String fieldValue, @Param("predicateName") @Nullable String predicateName, @Param("predicateValue") @Nullable String predicateValue);
    ...
    CompletableFuture<PageBeanFieldConfigurationItem> getFieldConfigurationItems(@Param("id") @NotNull Long id, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageBeanFieldConfigurationIssueTypeItem> getFieldConfigurationSchemeMappings(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("fieldConfigurationSchemeId") @Nullable Set<Long> fieldConfigurationSchemeId);
    ...
    CompletableFuture<PageBeanFieldConfigurationSchemeProjects> getFieldConfigurationSchemeProjectMapping(@Param("projectId") @NotNull Set<Long> projectId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<List<FieldDetails>> getFields();
    ...
    CompletableFuture<PageBeanField> getFieldsPaginated(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("type") @Nullable List<String> type, @Param("id") @Nullable Set<String> id, @Param("query") @Nullable String query, @Param("orderBy") @Nullable String orderBy, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<Filter> getFilter(@Param("id") @NotNull Long id, @Param("expand") @Nullable String expand, @Param("overrideSharePermissions") @Nullable Boolean overrideSharePermissions);
    ...
    CompletableFuture<Group> getGroup(@Param("groupname") @Nullable String groupname, @Param("groupId") @Nullable String groupId, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<ProjectIssueTypeHierarchy> getHierarchy(@Param("projectId") @NotNull Long projectId);
    ...
    CompletableFuture<ChangedWorklogs> getIdsOfWorklogsDeletedSince(@Param("since") @Nullable Long since);
    ...
    CompletableFuture<ChangedWorklogs> getIdsOfWorklogsModifiedSince(@Param("since") @Nullable Long since, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<BulkIssueIsWatching> getIsWatchingIssueBulk(@NotNull IssueList issueList);
    ...
    CompletableFuture<IssueBean> getIssue(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("fields") @Nullable List<String> fields, @Param("fieldsByKeys") @Nullable Boolean fieldsByKeys, @Param("expand") @Nullable String expand, @Param("properties") @Nullable List<String> properties, @Param("updateHistory") @Nullable Boolean updateHistory);
    ...
    CompletableFuture<List<IssueTypeDetails>> getIssueAllTypes();
    ...
    CompletableFuture<IssueFieldOption> getIssueFieldOption(@Param("fieldKey") @NotNull String fieldKey, @Param("optionId") @NotNull Long optionId);
    ...
    CompletableFuture<IssueLink> getIssueLink(@Param("linkId") @NotNull String linkId);
    ...
    CompletableFuture<IssueLinkType> getIssueLinkType(@Param("issueLinkTypeId") @NotNull String issueLinkTypeId);
    ...
    CompletableFuture<IssueLinkTypes> getIssueLinkTypes();
    ...
    CompletableFuture<List<ColumnItem>> getIssueNavigatorDefaultColumns();
     ...
     */
    @RequestLine("GET /rest/api/3/issue/picker?query={query}&currentJQL={currentJQL}&currentIssueKey={currentIssueKey}&currentProjectId={currentProjectId}&showSubTasks={showSubTasks}&showSubTaskParent={showSubTaskParent}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<IssuePickerSuggestions> getIssuePickerResource(@Param("query") @Nullable String query, @Param("currentJQL") @Nullable String currentJQL, @Param("currentIssueKey") @Nullable String currentIssueKey, @Param("currentProjectId") @Nullable String currentProjectId, @Param("showSubTasks") @Nullable Boolean showSubTasks, @Param("showSubTaskParent") @Nullable Boolean showSubTaskParent);
    ...
    CompletableFuture<EntityProperty> getIssueProperty(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<PropertyKeys> getIssuePropertyKeys(@Param("issueIdOrKey") @NotNull String issueIdOrKey);
    ...
    CompletableFuture<SecurityLevel> getIssueSecurityLevel(@Param("id") @NotNull String id);
    ...
    CompletableFuture<PageBeanIssueSecurityLevelMember> getIssueSecurityLevelMembers(@Param("issueSecuritySchemeId") @NotNull Long issueSecuritySchemeId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("issueSecurityLevelId") @Nullable Set<String> issueSecurityLevelId, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<SecurityScheme> getIssueSecurityScheme(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<SecuritySchemes> getIssueSecuritySchemes();
    ...
    CompletableFuture<IssueTypeDetails> getIssueType(@Param("id") @NotNull String id);
    ...
    CompletableFuture<PageBeanIssueTypeToContextMapping> getIssueTypeMappingsForContexts(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @Nullable List<Long> contextId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<EntityProperty> getIssueTypeProperty(@Param("issueTypeId") @NotNull String issueTypeId, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<PropertyKeys> getIssueTypePropertyKeys(@Param("issueTypeId") @NotNull String issueTypeId);
    ...
    CompletableFuture<PageBeanIssueTypeSchemeProjects> getIssueTypeSchemeForProjects(@Param("projectId") @NotNull Set<Long> projectId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageBeanIssueTypeSchemeMapping> getIssueTypeSchemesMapping(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("issueTypeSchemeId") @Nullable Set<Long> issueTypeSchemeId);
    ...
    CompletableFuture<PageBeanIssueTypeScreenSchemeItem> getIssueTypeScreenSchemeMappings(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("issueTypeScreenSchemeId") @Nullable Set<Long> issueTypeScreenSchemeId);
    ...
    CompletableFuture<PageBeanIssueTypeScreenSchemesProjects> getIssueTypeScreenSchemeProjectAssociations(@Param("projectId") @NotNull Set<Long> projectId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PageBeanIssueTypeScreenScheme> getIssueTypeScreenSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id, @Param("queryString") @Nullable String queryString, @Param("orderBy") @Nullable String orderBy, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<List<IssueTypeDetails>> getIssueTypesForProject(@Param("projectId") @NotNull Long projectId, @Param("level") @Nullable Integer level);
    ...
    CompletableFuture<Watchers> getIssueWatchers(@Param("issueIdOrKey") @NotNull String issueIdOrKey);
    ...
    CompletableFuture<PageOfWorklogs> getIssueWorklog(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("startedAfter") @Nullable Long startedAfter, @Param("startedBefore") @Nullable Long startedBefore, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<License> getLicense();
    ...
    CompletableFuture<Locale> getLocale();
    ...
    CompletableFuture<List<Filter>> getMyFilters(@Param("expand") @Nullable String expand, @Param("includeFavourites") @Nullable Boolean includeFavourites);
    ...
    CompletableFuture<NotificationScheme> getNotificationScheme(@Param("id") @NotNull Long id, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<NotificationScheme> getNotificationSchemeForProject(@Param("projectKeyOrId") @NotNull String projectKeyOrId, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("GET /rest/api/3/notificationscheme/project?startAt={startAt}&maxResults={maxResults}&notificationSchemeId={notificationSchemeId}&projectId={projectId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanNotificationSchemeAndProjectMappingJsonBean> getNotificationSchemeToProjectMappings(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("notificationSchemeId") @Nullable Set<String> notificationSchemeId, @Param("projectId") @Nullable Set<String> projectId);
    ...
    CompletableFuture<PageBeanNotificationScheme> getNotificationSchemes(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("id") @Nullable Set<String> id, @Param("projectId") @Nullable Set<String> projectId, @Param("onlyDefault") @Nullable Boolean onlyDefault, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PageBeanCustomFieldContextOption> getOptionsForContext(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @Param("optionId") @Nullable Long optionId, @Param("onlyOptions") @Nullable Boolean onlyOptions, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<PermissionScheme> getPermissionScheme(@Param("schemeId") @NotNull Long schemeId, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PermissionGrant> getPermissionSchemeGrant(@Param("schemeId") @NotNull Long schemeId, @Param("permissionId") @NotNull Long permissionId, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PermissionGrants> getPermissionSchemeGrants(@Param("schemeId") @NotNull Long schemeId, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PermittedProjects> getPermittedProjects(@NotNull PermissionsKeysBean permissionsKeysBean);
    ...
    CompletableFuture<PageBeanJqlFunctionPrecomputationBean> getPrecomputations(@Param("functionKey") @Nullable List<String> functionKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("orderBy") @Nullable String orderBy);
    ...
    CompletableFuture<String> getPreference(@Param("key") @NotNull String key);
    ...
    CompletableFuture<List<Priority>> getPriorities();
    ...
    CompletableFuture<Priority> getPriority(@Param("id") @NotNull String id);
    ...
    CompletableFuture<Project> getProject(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("expand") @Nullable String expand, @Param("properties") @Nullable List<String> properties);
    ...
    CompletableFuture<ProjectCategory> getProjectCategoryById(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<List<ProjectComponent>> getProjectComponents(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<PageBeanComponentWithIssueCount> getProjectComponentsPaginated(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("orderBy") @Nullable String orderBy, @Param("query") @Nullable String query);
    ...
    CompletableFuture<PageBeanCustomFieldContextProjectMapping> getProjectContextMapping(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @Nullable Set<Long> contextId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
    ...
    CompletableFuture<ProjectEmailAddress> getProjectEmail(@Param("projectId") @NotNull Long projectId);
    ...
    CompletableFuture<SecurityScheme> getProjectIssueSecurityScheme(@Param("projectKeyOrId") @NotNull String projectKeyOrId);
    ...
    CompletableFuture<EntityProperty> getProjectProperty(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("propertyKey") @NotNull String propertyKey);
    ...
    CompletableFuture<PropertyKeys> getProjectPropertyKeys(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<ProjectRole> getProjectRole(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("id") @NotNull Long id, @Param("excludeInactiveUsers") @Nullable Boolean excludeInactiveUsers);
    ...
    CompletableFuture<ProjectRole> getProjectRoleActorsForRole(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<ProjectRole> getProjectRoleById(@Param("id") @NotNull Long id);
    ...
    CompletableFuture<List<ProjectRoleDetails>> getProjectRoleDetails(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("currentMember") @Nullable Boolean currentMember, @Param("excludeConnectAddons") @Nullable Boolean excludeConnectAddons);
    ...
    CompletableFuture<Map<String, URI>> getProjectRoles(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
    ...
    CompletableFuture<ProjectType> getProjectTypeByKey(@Param("projectTypeKey") @NotNull String projectTypeKey);
    ...
    CompletableFuture<List<Version>> getProjectVersions(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("expand") @Nullable String expand);
    ...
    CompletableFuture<PageBeanProjectDetails> getProjectsForIssueTypeScreenScheme(@Param("issueTypeScreenSchemeId") @NotNull Long issueTypeScreenSchemeId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("query") @Nullable String query);
    ...
    CompletableFuture<List<Project>> getRecent(@Param("expand") @Nullable String expand, @Param("properties") @Nullable List<Object> properties);
     ...
     * @param id                   The ID of the version. (required)
     */
    @RequestLine("GET /rest/api/3/version/{id}/relatedwork")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<VersionRelatedWork>> getRelatedWork(@Param("id") @NotNull String id);
     ...
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/remotelink/{linkId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<RemoteIssueLink> getRemoteIssueLinkById(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("linkId") @NotNull String linkId);
     ...
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/remotelink?globalId={globalId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<RemoteIssueLink> getRemoteIssueLinks(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("globalId") @Nullable String globalId);
     ...
     */
    @RequestLine("GET /rest/api/3/resolution/{id}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Resolution> getResolution(@Param("id") @NotNull String id);
     ...
     */
    @Deprecated
    @RequestLine("GET /rest/api/3/resolution")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<Resolution>> getResolutions();
     ...
     */
    @RequestLine("GET /rest/api/3/screenscheme?startAt={startAt}&maxResults={maxResults}&id={id}&expand={expand}&queryString={queryString}&orderBy={orderBy}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanScreenScheme> getScreenSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id, @Param("expand") @Nullable String expand, @Param("queryString") @Nullable String queryString, @Param("orderBy") @Nullable String orderBy);
     ...
     */
    @RequestLine("GET /rest/api/3/screens?startAt={startAt}&maxResults={maxResults}&id={id}&queryString={queryString}&scope={scope}&orderBy={orderBy}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanScreen> getScreens(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id, @Param("queryString") @Nullable String queryString, @Param("scope") @Nullable Set<String> scope, @Param("orderBy") @Nullable String orderBy);
     ...
     */
    @RequestLine("GET /rest/api/3/field/{fieldId}/screens?startAt={startAt}&maxResults={maxResults}&expand={expand}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanScreenWithTab> getScreensForField(@Param("fieldId") @NotNull String fieldId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("expand") @Nullable String expand);
     ...
     * @param expand               Use expand to include additional information in the response. This parameter accepts a comma-separated list. Expand options include:   *  {@code all} Returns all expandable information  *  {@code field} Returns information about the custom field granted the permission  *  {@code group} Returns information about the group that is granted the permission  *  {@code projectRole} Returns information about the project role granted the permission  *  {@code user} Returns information about the user who is granted the permission (optional)
     */
    @RequestLine("GET /rest/api/3/issuesecurityschemes/level/member?startAt={startAt}&maxResults={maxResults}&id={id}&schemeId={schemeId}&levelId={levelId}&expand={expand}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanSecurityLevelMember> getSecurityLevelMembers(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("id") @Nullable Set<String> id, @Param("schemeId") @Nullable Set<String> schemeId, @Param("levelId") @Nullable Set<String> levelId, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("GET /rest/api/3/issuesecurityschemes/level?startAt={startAt}&maxResults={maxResults}&id={id}&schemeId={schemeId}&onlyDefault={onlyDefault}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanSecurityLevel> getSecurityLevels(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("id") @Nullable Set<String> id, @Param("schemeId") @Nullable Set<String> schemeId, @Param("onlyDefault") @Nullable Boolean onlyDefault);
     ...
     * @param projectKeyOrId       The project ID or project key (case sensitive). (required)
     */
    @RequestLine("GET /rest/api/3/project/{projectKeyOrId}/securitylevel")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<ProjectIssueSecurityLevels> getSecurityLevelsForProject(@Param("projectKeyOrId") @NotNull String projectKeyOrId);
     ...
     */
    @RequestLine("GET /rest/api/3/field/{fieldKey}/option/suggestions/edit?startAt={startAt}&maxResults={maxResults}&projectId={projectId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanIssueFieldOption> getSelectableIssueFieldOptions(@Param("fieldKey") @NotNull String fieldKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("projectId") @Nullable Long projectId);
     ...
     * Authentication - Required Scopes: [manage:jira-configuration]
     */
    @RequestLine("GET /rest/api/3/configuration/timetracking")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<TimeTrackingProvider> getSelectedTimeTrackingImplementation();
     ...
     *
     */
    @RequestLine("GET /rest/api/3/serverInfo")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<ServerInformation> getServerInfo();
     ...
     * @param permissionId         The ID of the share permission. (required)
     */
    @RequestLine("GET /rest/api/3/filter/{id}/permission/{permissionId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<SharePermission> getSharePermission(@Param("id") @NotNull Long id, @Param("permissionId") @NotNull Long permissionId);
     ...
     * @param id                   The ID of the filter. (required)
     */
    @RequestLine("GET /rest/api/3/filter/{id}/permission")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<SharePermission>> getSharePermissions(@Param("id") @NotNull Long id);
     ...
     * Authentication - Required Scopes: [manage:jira-configuration]
     */
    @RequestLine("GET /rest/api/3/configuration/timetracking/options")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<TimeTrackingConfiguration> getSharedTimeTrackingConfiguration();
     ...
     */
    @RequestLine("GET /rest/api/3/status/{idOrName}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<StatusDetails> getStatus(@Param("idOrName") @NotNull String idOrName);
     ...
     * Authentication - Required Scopes: [read:jira-work]
     */
    @RequestLine("GET /rest/api/3/statuscategory")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<StatusCategory>> getStatusCategories();
     ...
     */
    @RequestLine("GET /rest/api/3/statuscategory/{idOrKey}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<StatusCategory> getStatusCategory(@Param("idOrKey") @NotNull String idOrKey);
     ...
     * Authentication - Required Scopes: [read:jira-work]
     */
    @RequestLine("GET /rest/api/3/status")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<StatusDetails>> getStatuses();
     ...
     */
    @RequestLine("GET /rest/api/3/statuses?expand={expand}&id={id}")
    @Headers({
        "Accept: application/json"
    })
     ...
     * @param taskId               The ID of the task. (required)
     */
    @RequestLine("GET /rest/api/3/task/{taskId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<TaskProgressBeanObject> getTask(@Param("taskId") @NotNull String taskId);
     ...
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/transitions?expand={expand}&transitionId={transitionId}&skipRemoteOnlyCondition={skipRemoteOnlyCondition}&includeUnavailableTransitions={includeUnavailableTransitions}&sortByOpsBarAndStatus={sortByOpsBarAndStatus}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Transitions> getTransitions(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("expand") @Nullable String expand, @Param("transitionId") @Nullable String transitionId, @Param("skipRemoteOnlyCondition") @Nullable Boolean skipRemoteOnlyCondition, @Param("includeUnavailableTransitions") @Nullable Boolean includeUnavailableTransitions, @Param("sortByOpsBarAndStatus") @Nullable Boolean sortByOpsBarAndStatus);
     ...
     */
    @RequestLine("GET /rest/api/3/field/search/trashed?startAt={startAt}&maxResults={maxResults}&id={id}&query={query}&expand={expand}&orderBy={orderBy}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanField> getTrashedFieldsPaginated(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<String> id, @Param("query") @Nullable String query, @Param("expand") @Nullable String expand, @Param("orderBy") @Nullable String orderBy);
     ...
     */
    @RequestLine("GET /rest/api/3/uiModifications?startAt={startAt}&maxResults={maxResults}&expand={expand}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanUiModificationDetails> getUiModifications(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("GET /rest/api/3/user?accountId={accountId}&username={username}&key={key}&expand={expand}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<User> getUser(@Param("accountId") @Nullable String accountId, @Param("username") @Nullable String username, @Param("key") @Nullable String key, @Param("expand") @Nullable String expand);
     ...
     * @param username             This parameter is no longer available See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("GET /rest/api/3/user/columns?accountId={accountId}&username={username}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<ColumnItem>> getUserDefaultColumns(@Param("accountId") @Nullable String accountId, @Param("username") @Nullable String username);
     ...
     */
    @RequestLine("GET /rest/api/3/user/email?accountId={accountId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<UnrestrictedUserEmail> getUserEmail(@Param("accountId") @NotNull String accountId);
     ...
     */
    @RequestLine("GET /rest/api/3/user/email/bulk?accountId={accountId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<UnrestrictedUserEmail> getUserEmailBulk(@Param("accountId") @NotNull List<String> accountId);
     ...
     * @param key                  This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("GET /rest/api/3/user/groups?accountId={accountId}&username={username}&key={key}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<List<GroupName>> getUserGroups(@Param("accountId") @NotNull String accountId, @Param("username") @Nullable String username, @Param("key") @Nullable String key);
     ...
     * @param username             This parameter is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("GET /rest/api/3/user/properties/{propertyKey}?accountId={accountId}&userKey={userKey}&username={username}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<EntityProperty> getUserProperty(@Param("propertyKey") @NotNull String propertyKey, @Param("accountId") @Nullable String accountId, @Param("userKey") @Nullable String userKey, @Param("username") @Nullable String username);
     ...
     * @param username             This parameter is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("GET /rest/api/3/user/properties?accountId={accountId}&userKey={userKey}&username={username}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PropertyKeys> getUserPropertyKeys(@Param("accountId") @Nullable String accountId, @Param("userKey") @Nullable String userKey, @Param("username") @Nullable String username);
     ...
     * @param maxResults           The maximum number of items to return per page. (optional, defaults to 50)
     */
    @RequestLine("GET /rest/api/3/group/member?groupname={groupname}&groupId={groupId}&includeInactiveUsers={includeInactiveUsers}&startAt={startAt}&maxResults={maxResults}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanUserDetails> getUsersFromGroup(@Param("groupname") @Nullable String groupname, @Param("groupId") @Nullable String groupId, @Param("includeInactiveUsers") @Nullable Boolean includeInactiveUsers, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults);
     ...
     */
    @RequestLine("GET /rest/api/3/projectvalidate/validProjectKey?key={key}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<String> getValidProjectKey(@Param("key") @Nullable String key);
     ...
     */
    @RequestLine("GET /rest/api/3/projectvalidate/validProjectName?name={name}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<String> getValidProjectName(@Param("name") @NotNull String name);
    ...
    CompletableFuture<Version> getVersion(@Param("id") @NotNull String id, @Param("expand") @Nullable String expand);
     ...
     * @param id                   The ID of the version. (required)
     */
    @RequestLine("GET /rest/api/3/version/{id}/relatedIssueCounts")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<VersionIssueCounts> getVersionRelatedIssues(@Param("id") @NotNull String id);
     ...
     * @param id                   The ID of the version. (required)
     */
    @RequestLine("GET /rest/api/3/version/{id}/unresolvedIssueCount")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<VersionUnresolvedIssuesCount> getVersionUnresolvedIssues(@Param("id") @NotNull String id);
    ...
    CompletableFuture<PageBeanIssueFieldOption> getVisibleIssueFieldOptions(@Param("fieldKey") @NotNull String fieldKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("projectId") @Nullable Long projectId);
     ...
     * @param issueIdOrKey         The ID or key of the issue. (required)
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/votes")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Votes> getVotes(@Param("issueIdOrKey") @NotNull String issueIdOrKey);
     ...
     */
    @RequestLine("GET /rest/api/3/workflowscheme/{id}/workflow?workflowName={workflowName}&returnDraftIfExists={returnDraftIfExists}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<IssueTypesWorkflowMapping> getWorkflow(@Param("id") @NotNull Long id, @Param("workflowName") @Nullable String workflowName, @Param("returnDraftIfExists") @Nullable Boolean returnDraftIfExists);
     ...
     */
    @RequestLine("GET /rest/api/3/workflowscheme/{id}?returnDraftIfExists={returnDraftIfExists}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> getWorkflowScheme(@Param("id") @NotNull Long id, @Param("returnDraftIfExists") @Nullable Boolean returnDraftIfExists);
     ...
     * @param id                   The ID of the active workflow scheme that the draft was created from. (required)
     */
    @RequestLine("GET /rest/api/3/workflowscheme/{id}/draft")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> getWorkflowSchemeDraft(@Param("id") @NotNull Long id);
     ...
     * @param issueType            The ID of the issue type. (required)
     */
    @RequestLine("GET /rest/api/3/workflowscheme/{id}/draft/issuetype/{issueType}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<IssueTypeWorkflowMapping> getWorkflowSchemeDraftIssueType(@Param("id") @NotNull Long id, @Param("issueType") @NotNull String issueType);
     ...
     * @param returnDraftIfExists  Returns the mapping from the workflow scheme's draft rather than the workflow scheme, if set to true. If no draft exists, the mapping from the workflow scheme is returned. (optional, defaults to false)
     */
    @RequestLine("GET /rest/api/3/workflowscheme/{id}/issuetype/{issueType}?returnDraftIfExists={returnDraftIfExists}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<IssueTypeWorkflowMapping> getWorkflowSchemeIssueType(@Param("id") @NotNull Long id, @Param("issueType") @NotNull String issueType, @Param("returnDraftIfExists") @Nullable Boolean returnDraftIfExists);
     ...
     */
    @RequestLine("GET /rest/api/3/workflowscheme/project?projectId={projectId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<ContainerOfWorkflowSchemeAssociations> getWorkflowSchemeProjectAssociations(@Param("projectId") @NotNull Set<Long> projectId);
     ...
     */
    @RequestLine("GET /rest/api/3/workflow/transitions/{transitionId}/properties?includeReservedKeys={includeReservedKeys}&key={key}&workflowName={workflowName}&workflowMode={workflowMode}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<WorkflowTransitionProperty> getWorkflowTransitionProperties(@Param("transitionId") @NotNull Long transitionId, @Param("workflowName") @NotNull String workflowName, @Param("includeReservedKeys") @Nullable Boolean includeReservedKeys, @Param("key") @Nullable String key, @Param("workflowMode") @Nullable String workflowMode);
     ...
     * @param getWorkflowTransitionRuleConfigurationsRequest  (required)
     * @param startAt              The index of the first item to return in a page of results (page offset). (optional, defaults to 0)
     * @param maxResults           The maximum number of items to return per page. (optional, defaults to 10)
     ...
     */
    @RequestLine("GET /rest/api/3/workflow/rule/config?startAt={startAt}&maxResults={maxResults}&types={types}&keys={keys}&workflowNames={workflowNames}&withTags={withTags}&draft={draft}&expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<PageBeanWorkflowTransitionRules> getWorkflowTransitionRuleConfigurations(@Param("types") @NotNull Set<String> types, @NotNull GetWorkflowTransitionRuleConfigurationsRequest getWorkflowTransitionRuleConfigurationsRequest, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("keys") @Nullable Set<String> keys, @Param("workflowNames") @Nullable Set<String> workflowNames, @Param("withTags") @Nullable Set<String> withTags, @Param("draft") @Nullable Boolean draft, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("GET /rest/api/3/workflow/search?startAt={startAt}&maxResults={maxResults}&workflowName={workflowName}&expand={expand}&queryString={queryString}&orderBy={orderBy}&isActive={isActive}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanWorkflow> getWorkflowsPaginated(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("workflowName") @Nullable Set<String> workflowName, @Param("expand") @Nullable String expand, @Param("queryString") @Nullable String queryString, @Param("orderBy") @Nullable String orderBy, @Param("isActive") @Nullable Boolean isActive);
     ...
     * @param expand               Use [expand](#expansion) to include additional information about work logs in the response. This parameter accepts  {@code properties}, which returns worklog properties. (optional)
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/worklog/{id}?expand={expand}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Worklog> getWorklog(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("id") @NotNull String id, @Param("expand") @Nullable String expand);
     ...
     * @param propertyKey          The key of the property. (required)
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/worklog/{worklogId}/properties/{propertyKey}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<EntityProperty> getWorklogProperty(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("worklogId") @NotNull String worklogId, @Param("propertyKey") @NotNull String propertyKey);
     ...
     * @param worklogId            The ID of the worklog. (required)
     */
    @RequestLine("GET /rest/api/3/issue/{issueIdOrKey}/worklog/{worklogId}/properties")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PropertyKeys> getWorklogPropertyKeys(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("worklogId") @NotNull String worklogId);
     ...
     * @param expand               Use [expand](#expansion) to include additional information about worklogs in the response. This parameter accepts {@code properties} that returns the properties of each worklog. (optional)
     */
    @RequestLine("POST /rest/api/3/worklog/list?expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<List<Worklog>> getWorklogsForIds(@NotNull WorklogIdsRequestBean worklogIdsRequestBean, @Param("expand") @Nullable String expand);
     ...
     * This resource returns nothing on the creation of an issue link. To obtain the ID of the issue link, use {@code https://your-domain.atlassian.net/rest/api/3/issue/[linked issue key]?fields=issuelinks}.
     ...
     */
    @RequestLine("POST /rest/api/3/issueLink")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> linkIssues(@NotNull LinkIssueRequestJsonBean linkIssueRequestJsonBean);
     ...
     */
    @RequestLine("POST /rest/api/3/jql/match")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<IssueMatches> matchIssues(@NotNull IssuesAndJQLQueries issuesAndJQLQueries);
     ...
     * Consider using [ Delete and replace version](#api-rest-api-3-version-id-removeAndSwap-post) instead. This resource supports swapping version values in {@code fixVersion}, {@code affectedVersion}, and custom fields.
     * This operation can be accessed anonymously.
     * **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) or *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project that contains the version.
     *
     * Authentication - Required Scopes: [manage:jira-project]
     ...
     */
    @RequestLine("PUT /rest/api/3/version/{id}/mergeto/{moveIssuesTo}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> mergeVersions(@Param("id") @NotNull String id, @Param("moveIssuesTo") @NotNull String moveIssuesTo);
     ...
     */
    @RequestLine("POST /rest/api/3/jql/pdcleaner")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ConvertedJQLQueries> migrateQueries(@NotNull JQLPersonalDataMigrationRequest jqLPersonalDataMigrationRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/priority/move")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> movePriorities(@NotNull ReorderIssuePriorities reorderIssuePriorities);
     ...
     */
    @RequestLine("PUT /rest/api/3/resolution/move")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> moveResolutions(@NotNull ReorderIssueResolutionsRequest reorderIssueResolutionsRequest);
     ...
     */
    @RequestLine("POST /rest/api/3/screens/{screenId}/tabs/{tabId}/move/{pos}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> moveScreenTab(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId, @Param("pos") @NotNull Integer pos);
     ...
     */
    @RequestLine("POST /rest/api/3/screens/{screenId}/tabs/{tabId}/fields/{id}/move")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> moveScreenTabField(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId, @Param("id") @NotNull String id, @NotNull MoveFieldBean moveFieldBean);
     ...
     */
    @RequestLine("POST /rest/api/3/version/{id}/move")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Version> moveVersion(@Param("id") @NotNull String id, @NotNull VersionMoveBean versionMoveBean);
     ...
     */
    @RequestLine("POST /rest/api/3/issue/{issueIdOrKey}/notify")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> notify(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @NotNull Notification notification);
     ...
     */
    @RequestLine("POST /rest/api/3/jql/parse?validation={validation}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ParsedJqlQueries> parseJqlQueries(@NotNull JqlQueriesToParse jqlQueriesToParse, @Param("validation") @Nullable String validation);
     ...
     * @param createUpdateRoleRequestBean  (required)
     */
    @RequestLine("POST /rest/api/3/role/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ProjectRole> partialUpdateProjectRole(@Param("id") @NotNull Long id, @NotNull CreateUpdateRoleRequestBean createUpdateRoleRequestBean);
     ...
     * This operation is [asynchronous](#async). Follow the {@code location} link in the response to determine the status of the task and use [Get task](#api-rest-api-3-task-taskId-get) to obtain updates.
     * **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
     *
     * Authentication - Required Scopes: [manage:jira-configuration]
     * @param id                   The ID of the workflow scheme that the draft belongs to. (required)
     ...
     */
    @RequestLine("POST /rest/api/3/workflowscheme/{id}/draft/publish?validateOnly={validateOnly}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Void> publishDraftWorkflowScheme(@Param("id") @NotNull Long id, @NotNull PublishDraftWorkflowScheme publishDraftWorkflowScheme, @Param("validateOnly") @Nullable Boolean validateOnly);
     ...
     */
    @RequestLine("POST /rest/api/3/workflowscheme/read?expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<List<WorkflowSchemeReadResponse>> readWorkflowSchemes(@NotNull WorkflowSchemeReadRequest workflowSchemeReadRequest, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("POST /rest/api/3/workflows?expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowReadResponse> readWorkflows(@NotNull WorkflowReadRequest workflowReadRequest, @Param("expand") @Nullable String expand);
     ...
     * @param containerForWebhookIDs  (required)
     */
    @RequestLine("PUT /rest/api/3/webhook/refresh")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WebhooksExpirationDate> refreshWebhooks(@NotNull ContainerForWebhookIDs containerForWebhookIDs);
     ...
     */
    @RequestLine("POST /rest/api/3/webhook")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ContainerForRegisteredWebhooks> registerDynamicWebhooks(@NotNull WebhookRegistrationDetails webhookRegistrationDetails);
     ...
     * @param id                   The ID of the attachment. (required)
     */
    @RequestLine("DELETE /rest/api/3/attachment/{id}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeAttachment(@Param("id") @NotNull String id);
     ...
     * @param projectIds            (required)
     */
    @RequestLine("POST /rest/api/3/field/{fieldId}/context/{contextId}/project/remove")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> removeCustomFieldContextFromProjects(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull ProjectIds projectIds);
     ...
     */
    @RequestLine("DELETE /rest/api/3/dashboard/{dashboardId}/gadget/{gadgetId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> removeGadget(@Param("dashboardId") @NotNull Long dashboardId, @Param("gadgetId") @NotNull Long gadgetId);
     ...
     */
    @RequestLine("DELETE /rest/api/3/group?groupname={groupname}&groupId={groupId}&swapGroup={swapGroup}&swapGroupId={swapGroupId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeGroup(@Param("groupname") @Nullable String groupname, @Param("groupId") @Nullable String groupId, @Param("swapGroup") @Nullable String swapGroup, @Param("swapGroupId") @Nullable String swapGroupId);
     ...
     * @param issueTypeId          The ID of the issue type. (required)
     */
    @RequestLine("DELETE /rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype/{issueTypeId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> removeIssueTypeFromIssueTypeScheme(@Param("issueTypeSchemeId") @NotNull Long issueTypeSchemeId, @Param("issueTypeId") @NotNull Long issueTypeId);
     ...
     * @param issueTypeIds          (required)
     */
    @RequestLine("POST /rest/api/3/field/{fieldId}/context/{contextId}/issuetype/remove")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> removeIssueTypesFromContext(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull IssueTypeIds issueTypeIds);
     ...
     */
    @RequestLine("POST /rest/api/3/fieldconfigurationscheme/{id}/mapping/delete")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> removeIssueTypesFromGlobalFieldConfigurationScheme(@Param("id") @NotNull Long id, @NotNull IssueTypeIdsToRemove issueTypeIdsToRemove);
     ...
     */
    @RequestLine("DELETE /rest/api/3/issuesecurityschemes/{schemeId}/level/{levelId}?replaceWith={replaceWith}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeLevel(@Param("schemeId") @NotNull String schemeId, @Param("levelId") @NotNull String levelId, @Param("replaceWith") @Nullable String replaceWith);
     ...
     * @param issueTypeIds          (required)
     */
    @RequestLine("POST /rest/api/3/issuetypescreenscheme/{issueTypeScreenSchemeId}/mapping/remove")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> removeMappingsFromIssueTypeScreenScheme(@Param("issueTypeScreenSchemeId") @NotNull String issueTypeScreenSchemeId, @NotNull IssueTypeIds issueTypeIds);
     ...
     */
    @RequestLine("DELETE /rest/api/3/issuesecurityschemes/{schemeId}/level/{levelId}/member/{memberId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> removeMemberFromSecurityLevel(@Param("schemeId") @NotNull String schemeId, @Param("levelId") @NotNull String levelId, @Param("memberId") @NotNull String memberId);
     ...
     */
    @RequestLine("DELETE /rest/api/3/notificationscheme/{notificationSchemeId}/notification/{notificationId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> removeNotificationFromNotificationScheme(@Param("notificationSchemeId") @NotNull String notificationSchemeId, @Param("notificationId") @NotNull String notificationId);
     ...
     * @param key                  The key of the preference. (required)
     */
    @RequestLine("DELETE /rest/api/3/mypreferences?key={key}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removePreference(@Param("key") @NotNull String key);
     ...
     */
    @RequestLine("DELETE /rest/api/3/projectCategory/{id}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeProjectCategory(@Param("id") @NotNull Long id);
     ...
     * @param id                   The ID of the field. (required)
     */
    @RequestLine("DELETE /rest/api/3/screens/{screenId}/tabs/{tabId}/fields/{id}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeScreenTabField(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId, @Param("id") @NotNull String id);
     ...
     * @param key                  This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("DELETE /rest/api/3/user?accountId={accountId}&username={username}&key={key}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeUser(@Param("accountId") @NotNull String accountId, @Param("username") @Nullable String username, @Param("key") @Nullable String key);
     ...
     * @param username             This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("DELETE /rest/api/3/group/user?groupname={groupname}&groupId={groupId}&username={username}&accountId={accountId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeUserFromGroup(@Param("accountId") @NotNull String accountId, @Param("groupname") @Nullable String groupname, @Param("groupId") @Nullable String groupId, @Param("username") @Nullable String username);
     ...
     * @param issueIdOrKey         The ID or key of the issue. (required)
     */
    @RequestLine("DELETE /rest/api/3/issue/{issueIdOrKey}/votes")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeVote(@Param("issueIdOrKey") @NotNull String issueIdOrKey);
     ...
     * @param accountId            The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*. Required. (optional)
     */
    @RequestLine("DELETE /rest/api/3/issue/{issueIdOrKey}/watchers?username={username}&accountId={accountId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> removeWatcher(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("username") @Nullable String username, @Param("accountId") @Nullable String accountId);
     ...
     * @param screenableTab         (required)
     */
    @RequestLine("PUT /rest/api/3/screens/{screenId}/tabs/{tabId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ScreenableTab> renameScreenTab(@Param("screenId") @NotNull Long screenId, @Param("tabId") @NotNull Long tabId, @NotNull ScreenableTab screenableTab);
     ...
     */
    @RequestLine("PUT /rest/api/3/field/{fieldId}/context/{contextId}/option/move")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> reorderCustomFieldOptions(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull OrderOfCustomFieldOptions orderOfCustomFieldOptions);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype/move")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> reorderIssueTypesInIssueTypeScheme(@Param("issueTypeSchemeId") @NotNull Long issueTypeSchemeId, @NotNull OrderOfIssueTypes orderOfIssueTypes);
     ...
     */
    @RequestLine("DELETE /rest/api/3/field/{fieldKey}/option/{optionId}/issue?replaceWith={replaceWith}&jql={jql}&overrideScreenSecurity={overrideScreenSecurity}&overrideEditableFlag={overrideEditableFlag}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> replaceIssueFieldOption(@Param("fieldKey") @NotNull String fieldKey, @Param("optionId") @NotNull Long optionId, @Param("replaceWith") @Nullable Long replaceWith, @Param("jql") @Nullable String jql, @Param("overrideScreenSecurity") @Nullable Boolean overrideScreenSecurity, @Param("overrideEditableFlag") @Nullable Boolean overrideEditableFlag);
     ...
     * @param id                   The ID of the filter. (required)
     */
    @RequestLine("DELETE /rest/api/3/filter/{id}/columns")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> resetColumns(@Param("id") @NotNull Long id);
     ...
     * @param username             This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("DELETE /rest/api/3/user/columns?accountId={accountId}&username={username}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Void> resetUserColumns(@Param("accountId") @Nullable String accountId, @Param("username") @Nullable String username);
     ...
     * @param projectIdOrKey       The project ID or project key (case sensitive). (required)
     */
    @RequestLine("POST /rest/api/3/project/{projectIdOrKey}/restore")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Project> restore(@Param("projectIdOrKey") @NotNull String projectIdOrKey);
     ...
     * @param id                   The ID of a custom field. (required)
     */
    @RequestLine("POST /rest/api/3/field/{id}/restore")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Object> restoreCustomField(@Param("id") @NotNull String id);
     ...
     */
    @RequestLine("POST /rest/api/3/jql/sanitize")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<SanitizedJqlQueries> sanitiseJqlQueries(@NotNull JqlQueriesToSanitize jqlQueriesToSanitize);
     ...
     */
    @RequestLine("GET /rest/api/3/statuses/search?expand={expand}&projectId={projectId}&startAt={startAt}&maxResults={maxResults}&searchString={searchString}&statusCategory={statusCategory}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageOfStatuses> search(@Param("expand") @Nullable String expand, @Param("projectId") @Nullable String projectId, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("searchString") @Nullable String searchString, @Param("statusCategory") @Nullable String statusCategory);
     ...
     */
    @RequestLine("POST /rest/api/3/search")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<SearchResults> searchForIssuesUsingJqlPost(@NotNull SearchRequestBean searchRequestBean);
     ...
     */
    @RequestLine("GET /rest/api/3/priority/search?startAt={startAt}&maxResults={maxResults}&id={id}&projectId={projectId}&priorityName={priorityName}&onlyDefault={onlyDefault}")
    @Headers({
        "Accept: application/json"
    })
     ...
     * @param projectId            The list of project IDs to be filtered out. (optional)
     */
    @RequestLine("GET /rest/api/3/issuesecurityschemes/project?startAt={startAt}&maxResults={maxResults}&issueSecuritySchemeId={issueSecuritySchemeId}&projectId={projectId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanIssueSecuritySchemeToProjectMapping> searchProjectsUsingSecuritySchemes(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("issueSecuritySchemeId") @Nullable Set<String> issueSecuritySchemeId, @Param("projectId") @Nullable Set<String> projectId);
     ...
     */
    @RequestLine("GET /rest/api/3/resolution/search?startAt={startAt}&maxResults={maxResults}&id={id}&onlyDefault={onlyDefault}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanResolutionJsonBean> searchResolutions(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("id") @Nullable List<String> id, @Param("onlyDefault") @Nullable Boolean onlyDefault);
     ...
     */
    @RequestLine("GET /rest/api/3/issuesecurityschemes/search?startAt={startAt}&maxResults={maxResults}&id={id}&projectId={projectId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<PageBeanSecuritySchemeWithProjects> searchSecuritySchemes(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("id") @Nullable Set<String> id, @Param("projectId") @Nullable Set<String> projectId);
     ...
     */
    @RequestLine("PUT /rest/api/3/configuration/timetracking")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> selectTimeTrackingImplementation(@NotNull TimeTrackingProvider timeTrackingProvider);
    ...
    CompletableFuture<List<ServiceRegistry>> serviceRegistryResourceServicesGet(@Param("serviceIds") @NotNull List<String> serviceIds);
     ...
     */
    @RequestLine("PUT /rest/api/3/project/{projectIdOrKey}/role/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ProjectRole> setActors(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("id") @NotNull Long id, @NotNull ProjectRoleActorsUpdateBean projectRoleActorsUpdateBean);
     ...
     */
    @RequestLine("PUT /rest/api/3/application-properties/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ApplicationProperty> setApplicationProperty(@Param("id") @NotNull String id, @NotNull SimpleApplicationPropertyBean simpleApplicationPropertyBean);
     ...
     */
    @RequestLine("PUT /rest/api/3/announcementBanner")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setBanner(@NotNull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate);

    /**
     * Set columns
     * <p>
     * Sets the columns for a filter. Only navigable fields can be set as columns. Use [Get fields](#api-rest-api-3-field-get) to get the list fields in Jira. A navigable field has {@code navigable} set to {@code true}.
     * The parameters for this resource are expressed as HTML form data. For example, in curl:
     * {@code curl -X PUT -d columns=summary -d columns=description https://your-domain.atlassian.net/rest/api/3/filter/10000/columns}
     ...
     */
    @RequestLine("PUT /rest/api/3/filter/{id}/columns")
    @Headers({
        "Content-Type: */*", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setColumns(@Param("id") @NotNull Long id, @Nullable List<String> requestBody);
     ...
     * @param body                  (required)
     */
    @RequestLine("PUT /rest/api/3/comment/{commentId}/properties/{propertyKey}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setCommentProperty(@Param("commentId") @NotNull String commentId, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
    ...
    CompletableFuture<Object> setDashboardItemProperty(@Param("dashboardId") @NotNull String dashboardId, @Param("itemId") @NotNull String itemId, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuesecurityschemes/level/default")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setDefaultLevels(@NotNull SetDefaultLevelsRequest setDefaultLevelsRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/priority/default")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setDefaultPriority(@NotNull SetDefaultPriorityRequest setDefaultPriorityRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/resolution/default")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setDefaultResolution(@NotNull SetDefaultResolutionRequest setDefaultResolutionRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/filter/defaultShareScope")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<DefaultShareScope> setDefaultShareScope(@NotNull DefaultShareScope defaultShareScope);
     ...
     */
    @RequestLine("PUT /rest/api/3/field/{fieldId}/context/defaultValue")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setDefaultValues(@Param("fieldId") @NotNull String fieldId, @NotNull CustomFieldContextDefaultValueUpdate customFieldContextDefaultValueUpdate);
     ...
     * @param expand               Use [expand](#expansion) to include additional information about filter in the response. This parameter accepts a comma-separated list. Expand options include:   *  {@code sharedUsers} Returns the users that the filter is shared with. This includes users that can browse projects that the filter is shared with. If you don't specify {@code sharedUsers}, then the {@code sharedUsers} object is returned but it doesn't list any users. The list of users returned is limited to 1000, to access additional users append {@code [start-index:end-index]} to the expand request. For example, to access the next 1000 users, use {@code ?expand=sharedUsers[1001:2000]}.  *  {@code subscriptions} Returns the users that are subscribed to the filter. If you don't specify {@code subscriptions}, the {@code subscriptions} object is returned but it doesn't list any subscriptions. The list of subscriptions returned is limited to 1000, to access additional subscriptions append {@code [start-index:end-index]} to the expand request. For example, to access the next 1000 subscriptions, use {@code ?expand=subscriptions[1001:2000]}. (optional)
     */
    @RequestLine("PUT /rest/api/3/filter/{id}/favourite?expand={expand}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<Filter> setFavouriteForFilter(@Param("id") @NotNull Long id, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("PUT /rest/api/3/fieldconfigurationscheme/{id}/mapping")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setFieldConfigurationSchemeMapping(@Param("id") @NotNull Long id, @NotNull AssociateFieldConfigurationsWithIssueTypesRequest associateFieldConfigurationsWithIssueTypesRequest);
     ...
     * {@code curl -X PUT -d columns=summary -d columns=description https://your-domain.atlassian.net/rest/api/3/settings/columns}
     ...
     * @param body                  (required)
     */
    @RequestLine("PUT /rest/api/3/issue/{issueIdOrKey}/properties/{propertyKey}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setIssueProperty(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
     ...
     * @param body                  (required)
     */
    @RequestLine("PUT /rest/api/3/issuetype/{issueTypeId}/properties/{propertyKey}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setIssueTypeProperty(@Param("issueTypeId") @NotNull String issueTypeId, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
     ...
     */
    @Deprecated
    @RequestLine("PUT /rest/api/3/mypreferences/locale")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setLocale(@NotNull Locale locale);
     ...
     */
    @RequestLine("PUT /rest/api/3/mypreferences?key={key}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setPreference(@Param("key") @NotNull String key, @NotNull String body);
     ...
     * @param body                  (required)
     */
    @RequestLine("PUT /rest/api/3/project/{projectIdOrKey}/properties/{propertyKey}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setProjectProperty(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
     ...
     */
    @RequestLine("PUT /rest/api/3/configuration/timetracking/options")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<TimeTrackingConfiguration> setSharedTimeTrackingConfiguration(@NotNull TimeTrackingConfiguration timeTrackingConfiguration);
     ...
     * The parameters for this resource are expressed as HTML form data. For example, in curl:
     * {@code curl -X PUT -d columns=summary -d columns=description https://your-domain.atlassian.net/rest/api/3/user/columns?accountId=5b10ac8d82e05b22cc7d4ef5'}
     * **[Permissions](#permissions) required:**
     *  *
     * *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg), to set the columns on any user.
     * *
     * Permission to access Jira, to set the calling user's columns.
     *
     * @param userColumnRequestBody The ID of a column to set. To set multiple columns, send multiple {@code columns} parameters. (required)
     * @param accountId            The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*. (optional)
     */
    @RequestLine("PUT /rest/api/3/user/columns?accountId={accountId}")
    @Headers({
        "Content-Type: */*", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setUserColumns(@NotNull UserColumnRequestBody userColumnRequestBody, @Param("accountId") @Nullable String accountId);
     ...
     * @param username             This parameter is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. (optional)
     */
    @RequestLine("PUT /rest/api/3/user/properties/{propertyKey}?accountId={accountId}&userKey={userKey}&username={username}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setUserProperty(@Param("propertyKey") @NotNull String propertyKey, @NotNull Object body, @Param("accountId") @Nullable String accountId, @Param("userKey") @Nullable String userKey, @Param("username") @Nullable String username);
     ...
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/draft/issuetype/{issueType}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> setWorkflowSchemeDraftIssueType(@Param("id") @NotNull Long id, @Param("issueType") @NotNull String issueType, @NotNull IssueTypeWorkflowMapping issueTypeWorkflowMapping);
     ...
     * @param issueTypeWorkflowMapping The issue type-project mapping. (required)
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/issuetype/{issueType}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> setWorkflowSchemeIssueType(@Param("id") @NotNull Long id, @Param("issueType") @NotNull String issueType, @NotNull IssueTypeWorkflowMapping issueTypeWorkflowMapping);
     ...
     * @param body                  (required)
     */
    @RequestLine("PUT /rest/api/3/issue/{issueIdOrKey}/worklog/{worklogId}/properties/{propertyKey}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> setWorklogProperty(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("worklogId") @NotNull String worklogId, @Param("propertyKey") @NotNull String propertyKey, @NotNull Object body);
     ...
     * {@code --header 'Content-Type: image/&amp;lt; image_type&amp;gt;' }
     * {@code --data-binary "&amp;lt;@/path/to/file/with/your/avatar&amp;gt;" }
     * {@code --url 'https://your-domain.atlassian.net/rest/api/3/universal_avatar/type/{type}/owner/{entityId}'}
     * The avatar is cropped to a square. If no crop parameters are specified, the square originates at the top left of the image. The length of the square's sides is set to the smaller of the height or width of the image.
     * The cropped image is then used to create avatars of 16x16, 24x24, 32x32, and 48x48 in size.
     ...
     * @param y                    The Y coordinate of the top-left corner of the crop region. (optional, defaults to 0)
     */
    @RequestLine("POST /rest/api/3/universal_avatar/type/{type}/owner/{entityId}?x={x}&y={y}&size={size}")
    @Headers({
        "Content-Type: */*", 
        "Accept: application/json"
    })
    CompletableFuture<Avatar> storeAvatar(@Param("type") @NotNull String type, @Param("entityId") @NotNull String entityId, @Param("size") @NotNull Integer size, @NotNull Object body, @Param("x") @Nullable Integer x, @Param("y") @Nullable Integer y);
     ...
     */
    @RequestLine("PUT /rest/api/3/project/{projectIdOrKey}/features/{featureKey}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ContainerForProjectFeatures> toggleFeatureForProject(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("featureKey") @NotNull String featureKey, @NotNull ProjectFeatureState projectFeatureState);
     ...
     * @param id                   The ID of a custom field. (required)
     */
    @RequestLine("POST /rest/api/3/field/{id}/trash")
    @Headers({
        "Accept: application/json"
    })
     ...
     */
    @RequestLine("PUT /rest/api/3/issue/unarchive")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    ...
    CompletableFuture<Comment> updateComment(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("id") @NotNull String id, @NotNull Comment comment, @Param("notifyUsers") @Nullable Boolean notifyUsers, @Param("overrideEditableFlag") @Nullable Boolean overrideEditableFlag, @Param("expand") @Nullable String expand);
     ...
     * @param projectComponent      (required)
     */
    @RequestLine("PUT /rest/api/3/component/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<ProjectComponent> updateComponent(@Param("id") @NotNull String id, @NotNull ProjectComponent projectComponent);
     ...
     */
    @RequestLine("PUT /rest/api/3/field/{fieldId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateCustomField(@Param("fieldId") @NotNull String fieldId, @NotNull UpdateCustomFieldDetails updateCustomFieldDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/app/field/{fieldIdOrKey}/context/configuration")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateCustomFieldConfiguration(@Param("fieldIdOrKey") @NotNull String fieldIdOrKey, @NotNull CustomFieldConfigurations customFieldConfigurations);
     ...
     */
    @RequestLine("PUT /rest/api/3/field/{fieldId}/context/{contextId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateCustomFieldContext(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull CustomFieldContextUpdateDetails customFieldContextUpdateDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/field/{fieldId}/context/{contextId}/option")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<CustomFieldUpdatedContextOptionsList> updateCustomFieldOption(@Param("fieldId") @NotNull String fieldId, @Param("contextId") @NotNull Long contextId, @NotNull BulkCustomFieldOptionUpdateRequest bulkCustomFieldOptionUpdateRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/app/field/{fieldIdOrKey}/value?generateChangelog={generateChangelog}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateCustomFieldValue(@Param("fieldIdOrKey") @NotNull String fieldIdOrKey, @NotNull CustomFieldValueUpdateDetails customFieldValueUpdateDetails, @Param("generateChangelog") @Nullable Boolean generateChangelog);
     ...
     */
    @RequestLine("PUT /rest/api/3/dashboard/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Dashboard> updateDashboard(@Param("id") @NotNull String id, @NotNull DashboardDetails dashboardDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuetypescreenscheme/{issueTypeScreenSchemeId}/mapping/default")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateDefaultScreenScheme(@Param("issueTypeScreenSchemeId") @NotNull String issueTypeScreenSchemeId, @NotNull UpdateDefaultScreenScheme updateDefaultScreenScheme);
     ...
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/default")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> updateDefaultWorkflow(@Param("id") @NotNull Long id, @NotNull DefaultWorkflow defaultWorkflow);
     ...
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/draft/default")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> updateDraftDefaultWorkflow(@Param("id") @NotNull Long id, @NotNull DefaultWorkflow defaultWorkflow);
     ...
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/draft/workflow?workflowName={workflowName}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> updateDraftWorkflowMapping(@Param("id") @NotNull Long id, @Param("workflowName") @NotNull String workflowName, @NotNull IssueTypesWorkflowMapping issueTypesWorkflowMapping);
     ...
     * @param fieldConfigurationDetails  (required)
     */
    @RequestLine("PUT /rest/api/3/fieldconfiguration/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateFieldConfiguration(@Param("id") @NotNull Long id, @NotNull FieldConfigurationDetails fieldConfigurationDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/fieldconfiguration/{id}/fields")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateFieldConfigurationItems(@Param("id") @NotNull Long id, @NotNull FieldConfigurationItemsDetails fieldConfigurationItemsDetails);
     ...
     * @param updateFieldConfigurationSchemeDetails The details of the field configuration scheme. (required)
     */
    @RequestLine("PUT /rest/api/3/fieldconfigurationscheme/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateFieldConfigurationScheme(@Param("id") @NotNull Long id, @NotNull UpdateFieldConfigurationSchemeDetails updateFieldConfigurationSchemeDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/filter/{id}?expand={expand}&overrideSharePermissions={overrideSharePermissions}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Filter> updateFilter(@Param("id") @NotNull Long id, @NotNull Filter filter, @Param("expand") @Nullable String expand, @Param("overrideSharePermissions") @Nullable Boolean overrideSharePermissions);
     ...
     */
    @RequestLine("PUT /rest/api/3/dashboard/{dashboardId}/gadget/{gadgetId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateGadget(@Param("dashboardId") @NotNull Long dashboardId, @Param("gadgetId") @NotNull Long gadgetId, @NotNull DashboardGadgetUpdateRequest dashboardGadgetUpdateRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/field/{fieldKey}/option/{optionId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<IssueFieldOption> updateIssueFieldOption(@Param("fieldKey") @NotNull String fieldKey, @Param("optionId") @NotNull Long optionId, @NotNull IssueFieldOption issueFieldOption);
     ...
     * @param issueLinkType         (required)
     */
    @RequestLine("PUT /rest/api/3/issueLinkType/{issueLinkTypeId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<IssueLinkType> updateIssueLinkType(@Param("issueLinkTypeId") @NotNull String issueLinkTypeId, @NotNull IssueLinkType issueLinkType);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuesecurityschemes/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateIssueSecurityScheme(@Param("id") @NotNull String id, @NotNull UpdateIssueSecuritySchemeRequestBean updateIssueSecuritySchemeRequestBean);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuetype/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<IssueTypeDetails> updateIssueType(@Param("id") @NotNull String id, @NotNull IssueTypeUpdateBean issueTypeUpdateBean);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuetypescheme/{issueTypeSchemeId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateIssueTypeScheme(@Param("issueTypeSchemeId") @NotNull Long issueTypeSchemeId, @NotNull IssueTypeSchemeUpdateDetails issueTypeSchemeUpdateDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuetypescreenscheme/{issueTypeScreenSchemeId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateIssueTypeScreenScheme(@Param("issueTypeScreenSchemeId") @NotNull String issueTypeScreenSchemeId, @NotNull IssueTypeScreenSchemeUpdateDetails issueTypeScreenSchemeUpdateDetails);
     ...
     * @param generateChangelog    Whether to generate a changelog for this update. (optional, defaults to true)
     */
    @RequestLine("POST /rest/api/3/app/field/value?generateChangelog={generateChangelog}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateMultipleCustomFieldValues(@NotNull MultipleCustomFieldValuesUpdateDetails multipleCustomFieldValuesUpdateDetails, @Param("generateChangelog") @Nullable Boolean generateChangelog);
     ...
     */
    @RequestLine("PUT /rest/api/3/notificationscheme/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateNotificationScheme(@Param("id") @NotNull String id, @NotNull UpdateNotificationSchemeDetails updateNotificationSchemeDetails);
     ...
     * @param expand               Use expand to include additional information in the response. This parameter accepts a comma-separated list. Note that permissions are always included when you specify any value. Expand options include:   *  {@code all} Returns all expandable information.  *  {@code field} Returns information about the custom field granted the permission.  *  {@code group} Returns information about the group that is granted the permission.  *  {@code permissions} Returns all permission grants for each permission scheme.  *  {@code projectRole} Returns information about the project role granted the permission.  *  {@code user} Returns information about the user who is granted the permission. (optional)
     */
    @RequestLine("PUT /rest/api/3/permissionscheme/{schemeId}?expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<PermissionScheme> updatePermissionScheme(@Param("schemeId") @NotNull Long schemeId, @NotNull PermissionScheme permissionScheme, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("POST /rest/api/3/jql/function/computation")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updatePrecomputations(@NotNull JqlFunctionPrecomputationUpdateRequestBean jqlFunctionPrecomputationUpdateRequestBean);
     ...
     */
    @RequestLine("PUT /rest/api/3/priority/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updatePriority(@Param("id") @NotNull String id, @NotNull UpdatePriorityDetails updatePriorityDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/project/{projectIdOrKey}?expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Project> updateProject(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @NotNull UpdateProjectDetails updateProjectDetails, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("PUT /rest/api/3/project/{projectIdOrKey}/avatar")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateProjectAvatar(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @NotNull Avatar avatar);
     ...
     * @param projectCategory       (required)
     */
    @RequestLine("PUT /rest/api/3/projectCategory/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<UpdatedProjectCategory> updateProjectCategory(@Param("id") @NotNull Long id, @NotNull ProjectCategory projectCategory);
     ...
     */
    @RequestLine("PUT /rest/api/3/project/{projectId}/email")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateProjectEmail(@Param("projectId") @NotNull Long projectId, @NotNull ProjectEmailAddress projectEmailAddress);
     ...
     * @param versionRelatedWork    (required)
     */
    @RequestLine("PUT /rest/api/3/version/{id}/relatedwork")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<VersionRelatedWork> updateRelatedWork(@Param("id") @NotNull String id, @NotNull VersionRelatedWork versionRelatedWork);
     ...
     * @param remoteIssueLinkRequest  (required)
     */
    @RequestLine("PUT /rest/api/3/issue/{issueIdOrKey}/remotelink/{linkId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateRemoteIssueLink(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("linkId") @NotNull String linkId, @NotNull RemoteIssueLinkRequest remoteIssueLinkRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/resolution/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateResolution(@Param("id") @NotNull String id, @NotNull UpdateResolutionDetails updateResolutionDetails);
     ...
     */
    @RequestLine("POST /rest/api/3/workflowscheme/update")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateSchemes(@NotNull WorkflowSchemeUpdateRequest workflowSchemeUpdateRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/screens/{screenId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Screen> updateScreen(@Param("screenId") @NotNull Long screenId, @NotNull UpdateScreenDetails updateScreenDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/screenscheme/{screenSchemeId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateScreenScheme(@Param("screenSchemeId") @NotNull String screenSchemeId, @NotNull UpdateScreenSchemeDetails updateScreenSchemeDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/issuesecurityschemes/{schemeId}/level/{levelId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateSecurityLevel(@Param("schemeId") @NotNull String schemeId, @Param("levelId") @NotNull String levelId, @NotNull UpdateIssueSecurityLevelDetails updateIssueSecurityLevelDetails);
     ...
     */
    @RequestLine("PUT /rest/api/3/statuses")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateStatuses(@NotNull StatusUpdateRequest statusUpdateRequest);
     ...
     */
    @RequestLine("PUT /rest/api/3/uiModifications/{uiModificationId}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Object> updateUiModification(@Param("uiModificationId") @NotNull String uiModificationId, @NotNull UpdateUiModificationDetails updateUiModificationDetails);
     ...
     * @param version               (required)
     */
    @RequestLine("PUT /rest/api/3/version/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Version> updateVersion(@Param("id") @NotNull String id, @NotNull Version version);
     ...
     * @param issueTypesWorkflowMapping  (required)
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/workflow?workflowName={workflowName}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> updateWorkflowMapping(@Param("id") @NotNull Long id, @Param("workflowName") @NotNull String workflowName, @NotNull IssueTypesWorkflowMapping issueTypesWorkflowMapping);
     ...
     * @param workflowScheme        (required)
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> updateWorkflowScheme(@Param("id") @NotNull Long id, @NotNull WorkflowScheme workflowScheme);
     ...
     * @param workflowScheme        (required)
     */
    @RequestLine("PUT /rest/api/3/workflowscheme/{id}/draft")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowScheme> updateWorkflowSchemeDraft(@Param("id") @NotNull Long id, @NotNull WorkflowScheme workflowScheme);
     ...
     */
    @RequestLine("POST /rest/api/3/workflowscheme/update/mappings")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowSchemeUpdateRequiredMappingsResponse> updateWorkflowSchemeMappings(@NotNull WorkflowSchemeUpdateRequiredMappingsRequest workflowSchemeUpdateRequiredMappingsRequest);
     ...
     * @param workflowMode         The workflow status. Set to {@code live} for inactive workflows or {@code draft} for draft workflows. Active workflows cannot be edited. (optional)
     */
    @RequestLine("PUT /rest/api/3/workflow/transitions/{transitionId}/properties?key={key}&workflowName={workflowName}&workflowMode={workflowMode}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowTransitionProperty> updateWorkflowTransitionProperty(@Param("transitionId") @NotNull Long transitionId, @Param("key") @NotNull String key, @Param("workflowName") @NotNull String workflowName, @NotNull WorkflowTransitionProperty workflowTransitionProperty, @Param("workflowMode") @Nullable String workflowMode);
     ...
     */
    @RequestLine("PUT /rest/api/3/workflow/rule/config")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowTransitionRulesUpdateErrors> updateWorkflowTransitionRuleConfigurations(@NotNull WorkflowTransitionRulesUpdate workflowTransitionRulesUpdate);
     ...
     * @param expand               Use [expand](#expansion) to include additional information in the response. This parameter accepts a comma-separated list. Expand options include:   *  {@code workflows.usages} Returns the project and issue types that each workflow is associated with.  *  {@code statuses.usages} Returns the project and issue types that each status is associated with. (optional)
     */
    @RequestLine("POST /rest/api/3/workflows/update?expand={expand}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowUpdateResponse> updateWorkflows(@NotNull WorkflowUpdateRequest workflowUpdateRequest, @Param("expand") @Nullable String expand);
     ...
     */
    @RequestLine("PUT /rest/api/3/issue/{issueIdOrKey}/worklog/{id}?notifyUsers={notifyUsers}&adjustEstimate={adjustEstimate}&newEstimate={newEstimate}&expand={expand}&overrideEditableFlag={overrideEditableFlag}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<Worklog> updateWorklog(@Param("issueIdOrKey") @NotNull String issueIdOrKey, @Param("id") @NotNull String id, @NotNull Worklog worklog, @Param("notifyUsers") @Nullable Boolean notifyUsers, @Param("adjustEstimate") @Nullable String adjustEstimate, @Param("newEstimate") @Nullable String newEstimate, @Param("expand") @Nullable String expand, @Param("overrideEditableFlag") @Nullable Boolean overrideEditableFlag);
     ...
     */
    @RequestLine("POST /rest/api/3/workflows/create/validation")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowValidationErrorList> validateCreateWorkflows(@NotNull WorkflowCreateValidateRequest workflowCreateValidateRequest);
     ...
     * @param key                  The project key. (optional)
     */
    @RequestLine("GET /rest/api/3/projectvalidate/key?key={key}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<ErrorCollection> validateProjectKey(@Param("key") @Nullable String key);
     ...
     */
    @RequestLine("POST /rest/api/3/workflows/update/validation")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
    CompletableFuture<WorkflowValidationErrorList> validateUpdateWorkflows(@NotNull WorkflowUpdateValidateRequestBean workflowUpdateValidateRequestBean);
     ...
     */
    @RequestLine("GET /rest/api/3/workflows/capabilities?workflowId={workflowId}&projectId={projectId}&issueTypeId={issueTypeId}")
    @Headers({
        "Accept: application/json"
    })
    CompletableFuture<WorkflowCapabilities> workflowCapabilities(@Param("workflowId") @Nullable String workflowId, @Param("projectId") @Nullable String projectId, @Param("issueTypeId") @Nullable String issueTypeId);
