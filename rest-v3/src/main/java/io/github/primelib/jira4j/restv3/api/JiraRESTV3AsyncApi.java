...
public interface JiraRESTV3AsyncApi {
    ...
    CompletableFuture<PageBeanFieldConfigurationScheme> getAllFieldConfigurationSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id);
    ...
    CompletableFuture<PageBeanJqlFunctionPrecomputationBean> getPrecomputations(@Param("functionKey") @Nullable List<String> functionKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("orderBy") @Nullable String orderBy, @Param("filter") @Nullable String filter);
     ...
     */
    @RequestLine("GET /rest/api/3/priority/search?startAt={startAt}&maxResults={maxResults}&id={id}&projectId={projectId}&onlyDefault={onlyDefault}")
    @Headers({
        "Accept: application/json"
    })
    ...
    CompletableFuture<Object> setUserColumns(@Param("accountId") @Nullable String accountId, @Nullable List<String> requestBody);
