...
public interface JiraRESTV3AsyncApi {
    ...
    CompletableFuture<List<ProjectComponent>> getProjectComponents(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("componentSource") @Nullable String componentSource);
    ...
    CompletableFuture<PageBeanComponentWithIssueCount> getProjectComponentsPaginated(@Param("projectIdOrKey") @NotNull String projectIdOrKey, @Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("orderBy") @Nullable String orderBy, @Param("componentSource") @Nullable String componentSource, @Param("query") @Nullable String query);
