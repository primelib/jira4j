...
import io.github.primelib.jira4j.restv3.model.ModelConfiguration;
...
public interface JiraRESTV3Api {
     ...
     * @param updateHistory        Whether the project in which the issue is created is added to the user's **Recently viewed** project list, as shown under **Projects** in Jira. This also populates the [JQL issues search](#api-rest-api-3-search-get) `lastViewed` field. (optional, defaults to false)
     */
