...
public interface JiraRESTV3Api {
    ...
    Object deleteStatusesById(@Param("id") @NotNull List<String> id);
    ...
    PageBeanFieldConfigurationScheme getAllFieldgRnfigurationSchemes(@Param("startAt") @Nullable Long startAt, @Param("maxResults") @Nullable Integer maxResults, @Param("id") @Nullable Set<Long> id);
    ...
    List<JiraStatus> getStatusesById(@Param("id") @NotNull List<String> id, @Param("expand") @Nullable String expand);
    ...
    PageBeanPriority searchPriorities(@Param("startAt") @Nullable String startAt, @Param("maxResults") @Nullable String maxResults, @Param("id") @Nullable List<String> id, @Param("projectId") @Nullable List<String> projectId, @Param("priorityName") @Nullable String priorityName, @Param("onlyDefault") @Nullable Boolean onlyDefault);
    ...
    List<ServiceRegistry> serviceRegistryResourceServicesGet(@Param("serviceIds") @NotNull List<String> serviceIds);
    ...
    void setIssueNavigatorDefaultColumns(@NotNull ColumnRequestBody columnRequestBody);
    ...
    Object setUserColumns(@NotNull UserColumnRequestBody userColumnRequestBody, @Param("accountId") @Nullable String accountId);
