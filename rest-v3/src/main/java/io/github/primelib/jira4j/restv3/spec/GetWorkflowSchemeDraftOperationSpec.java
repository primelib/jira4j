...
public class GetWorkflowSchemeDraftOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetWorkflowSchemeDraftOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetWorkflowSchemeDraftOperationSpec(Consumer<GetWorkflowSchemeDraftOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetWorkflowSchemeDraftOperationSpec(Long id) {
        this.id = id;
