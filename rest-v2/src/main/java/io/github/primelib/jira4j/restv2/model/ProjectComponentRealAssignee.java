...
public class ProjectComponentRealAssignee {
    ...
    /**
     * Constructs a validated instance of {@link ProjectComponentRealAssignee}.
     *
     ...
     * Constructs a validated instance of {@link ProjectComponentRealAssignee}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ProjectComponentRealAssignee(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ProjectComponentRealAssignee(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
