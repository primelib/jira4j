...
public class ReorderIssueTypesInIssueTypeSchemeOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link ReorderIssueTypesInIssueTypeSchemeOperationSpec}.
     *
     ...
     * @param orderOfIssueTypes    
     */
    @ApiStatus.Internal
    public ReorderIssueTypesInIssueTypeSchemeOperationSpec(Long issueTypeSchemeId, OrderOfIssueTypes orderOfIssueTypes) {
        this.issueTypeSchemeId = issueTypeSchemeId;
        this.orderOfIssueTypes = orderOfIssueTypes;
