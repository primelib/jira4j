...
public class PageBeanString {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanString}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanString}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanString(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanString(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<String> values) {
        this.isLast = isLast;
