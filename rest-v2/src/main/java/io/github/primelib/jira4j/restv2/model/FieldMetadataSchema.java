...
public class FieldMetadataSchema {
    ...
    /**
     * Constructs a validated instance of {@link FieldMetadataSchema}.
     *
     ...
     * Constructs a validated instance of {@link FieldMetadataSchema}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #FieldMetadataSchema(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public FieldMetadataSchema(Map<String, Object> configuration, String custom, Long customId, String items, String system, String type) {
