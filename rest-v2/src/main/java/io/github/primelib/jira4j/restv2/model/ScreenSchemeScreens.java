...
public class ScreenSchemeScreens {
    ...
    /**
     * Constructs a validated instance of {@link ScreenSchemeScreens}.
     *
     ...
     * Constructs a validated instance of {@link ScreenSchemeScreens}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ScreenSchemeScreens(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ScreenSchemeScreens(Long create, Long _default, Long edit, Long view) {
        this.create = create;
