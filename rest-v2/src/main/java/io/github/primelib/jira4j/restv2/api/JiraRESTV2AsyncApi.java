...
public interface JiraRESTV2AsyncApi {
     ...
     */
    @RequestLine("PUT /rest/api/2/issue/{issueIdOrKey}?notifyUsers={notifyUsers}&overrideScreenSecurity={overrideScreenSecurity}&overrideEditableFlag={overrideEditableFlag}")
    @Headers({
        "Content-Type: application/json", 
        "Accept: application/json"
    })
