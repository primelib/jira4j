...
public class GetPermittedProjectsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetPermittedProjectsOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public GetPermittedProjectsOperationSpec(PermissionsKeysBean permissionsKeysBean) {
        this.permissionsKeysBean = permissionsKeysBean;
