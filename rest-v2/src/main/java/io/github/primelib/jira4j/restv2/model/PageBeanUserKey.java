...
public class PageBeanUserKey {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanUserKey}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanUserKey}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanUserKey(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanUserKey(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<UserKey> values) {
        this.isLast = isLast;
