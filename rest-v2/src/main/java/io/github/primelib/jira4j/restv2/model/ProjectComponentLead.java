...
public class ProjectComponentLead {
    ...
    /**
     * Constructs a validated instance of {@link ProjectComponentLead}.
     *
     ...
     * Constructs a validated instance of {@link ProjectComponentLead}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ProjectComponentLead(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public ProjectComponentLead(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
