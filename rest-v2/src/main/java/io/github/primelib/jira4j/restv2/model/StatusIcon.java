...
public class StatusIcon {
    ...
    /**
     * Constructs a validated instance of {@link StatusIcon}.
     *
     * @param spec the specification to process
     */
    public StatusIcon(Consumer<StatusIcon> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link StatusIcon}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #StatusIcon(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public StatusIcon(String link, String title, String url16x16) {
        this.link = link;
        this.title = title;
