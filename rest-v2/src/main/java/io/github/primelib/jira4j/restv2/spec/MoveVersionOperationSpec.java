...
public class MoveVersionOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link MoveVersionOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public MoveVersionOperationSpec(String id, VersionMoveBean versionMoveBean) {
        this.id = id;
        this.versionMoveBean = versionMoveBean;
