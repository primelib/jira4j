...
public class WorkflowSchemeLastModifiedUser {
    ...
    /**
     * Constructs a validated instance of {@link WorkflowSchemeLastModifiedUser}.
     *
     ...
     * Constructs a validated instance of {@link WorkflowSchemeLastModifiedUser}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #WorkflowSchemeLastModifiedUser(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public WorkflowSchemeLastModifiedUser(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
