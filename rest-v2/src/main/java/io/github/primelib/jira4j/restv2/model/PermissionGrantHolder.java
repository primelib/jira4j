...
public class PermissionGrantHolder {
    ...
    /**
     * Constructs a validated instance of {@link PermissionGrantHolder}.
     *
     ...
     * Constructs a validated instance of {@link PermissionGrantHolder}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PermissionGrantHolder(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PermissionGrantHolder(String expand, String parameter, String type, String value) {
        this.expand = expand;
