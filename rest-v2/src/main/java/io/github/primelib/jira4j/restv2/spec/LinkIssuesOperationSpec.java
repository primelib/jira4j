...
public class LinkIssuesOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link LinkIssuesOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public LinkIssuesOperationSpec(LinkIssueRequestJsonBean linkIssueRequestJsonBean) {
        this.linkIssueRequestJsonBean = linkIssueRequestJsonBean;
