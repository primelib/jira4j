...
public class PageBeanChangelog {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanChangelog}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanChangelog}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanChangelog(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanChangelog(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<Changelog> values) {
        this.isLast = isLast;
