...
public class Worklog {
     ...
     */
    @ApiStatus.Internal
    public Worklog(WorklogAuthor author, String comment, OffsetDateTime created, String id, String issueId, List<EntityProperty> properties, URI self, OffsetDateTime started, String timeSpent, Long timeSpentSeconds, WorklogUpdateAuthor updateAuthor, OffsetDateTime updated, WorklogVisibility visibility) {
        this.author = author;
