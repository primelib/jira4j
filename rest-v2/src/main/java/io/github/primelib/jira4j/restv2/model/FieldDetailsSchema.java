...
public class FieldDetailsSchema {
    ...
    /**
     * Constructs a validated instance of {@link FieldDetailsSchema}.
     *
     ...
     * Constructs a validated instance of {@link FieldDetailsSchema}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #FieldDetailsSchema(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public FieldDetailsSchema(Map<String, Object> configuration, String custom, Long customId, String items, String system, String type) {
