...
@JsonTypeName("HistoryMetadata_cause")
...
public class HistoryMetadataCause {
    ...
    /**
     * Constructs a validated instance of {@link HistoryMetadataCause}.
     *
     ...
     * Constructs a validated instance of {@link HistoryMetadataCause}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #HistoryMetadataCause(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public HistoryMetadataCause(String avatarUrl, String displayName, String displayNameKey, String id, String type, String url) {
