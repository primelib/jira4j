...
public class GetAllIssueFieldOptionsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetAllIssueFieldOptionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetAllIssueFieldOptionsOperationSpec(Consumer<GetAllIssueFieldOptionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetAllIssueFieldOptionsOperationSpec(String fieldKey, Long startAt, Integer maxResults) {
