...
public class CreateUserOperationSpec {
     ...
     * @param newUserDetails       Details about the user to be created.
     */
    @ApiStatus.Internal
    public CreateUserOperationSpec(NewUserDetails newUserDetails) {
    ...
    public void validate() {
        Objects.requireNonNull(newUserDetails, "newUserDetails is a required parameter!");
    }
}
