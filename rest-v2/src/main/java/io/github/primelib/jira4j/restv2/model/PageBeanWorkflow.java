...
public class PageBeanWorkflow {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanWorkflow}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanWorkflow}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanWorkflow(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanWorkflow(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<Workflow> values) {
        this.isLast = isLast;
