...
public class FilterOwner {
    ...
    /**
     * Constructs a validated instance of {@link FilterOwner}.
     *
     * @param spec the specification to process
     */
    public FilterOwner(Consumer<FilterOwner> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link FilterOwner}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #FilterOwner(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public FilterOwner(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
