...
public class PageBeanNotificationScheme {
    ...
    /**
     * Constructs a validated instance of {@link PageBeanNotificationScheme}.
     *
     ...
     * Constructs a validated instance of {@link PageBeanNotificationScheme}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #PageBeanNotificationScheme(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public PageBeanNotificationScheme(Boolean isLast, Integer maxResults, URI nextPage, URI self, Long startAt, Long total, List<NotificationScheme> values) {
        this.isLast = isLast;
