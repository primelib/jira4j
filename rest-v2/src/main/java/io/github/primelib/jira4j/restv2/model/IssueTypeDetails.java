...
public class IssueTypeDetails {
     ...
     */
    @ApiStatus.Internal
    public IssueTypeDetails(Long avatarId, String description, UUID entityId, Integer hierarchyLevel, String iconUrl, String id, String name, IssueTypeDetailsScope scope, String self, Boolean subtask) {
