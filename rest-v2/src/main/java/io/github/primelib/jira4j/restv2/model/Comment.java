...
public class Comment {
     ...
     */
    @ApiStatus.Internal
    public Comment(CommentAuthor author, String body, OffsetDateTime created, String id, Boolean jsdAuthorCanSeeRequest, Boolean jsdPublic, List<EntityProperty> properties, String renderedBody, String self, CommentUpdateAuthor updateAuthor, OffsetDateTime updated, CommentVisibility visibility) {
        this.author = author;
        this.body = body;
