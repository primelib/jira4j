...
public class FilterSubscriptionUser {
    ...
    /**
     * Constructs a validated instance of {@link FilterSubscriptionUser}.
     *
     * @param spec the specification to process
     */
    public FilterSubscriptionUser(Consumer<FilterSubscriptionUser> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link FilterSubscriptionUser}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #FilterSubscriptionUser(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public FilterSubscriptionUser(String accountId, AccountTypeEnum accountType, Boolean active, UserApplicationRoles applicationRoles, UserAvatarUrls avatarUrls, String displayName, String emailAddress, String expand, UserGroups groups, String key, String locale, String name, URI self, String timeZone) {
