...
public class DeleteAndReplaceVersionOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link DeleteAndReplaceVersionOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public DeleteAndReplaceVersionOperationSpec(String id, DeleteAndReplaceVersionBean deleteAndReplaceVersionBean) {
        this.id = id;
        this.deleteAndReplaceVersionBean = deleteAndReplaceVersionBean;
