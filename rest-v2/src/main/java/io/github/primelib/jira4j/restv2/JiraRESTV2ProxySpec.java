...
@Slf4j
public class JiraRESTV2ProxySpec {
    /*
    ...
    /**
     * Constructs a validated implementation of {@link JiraRESTV2ProxySpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public JiraRESTV2ProxySpec(Consumer<JiraRESTV2ProxySpec> spec) {
        spec.accept(this);
        validate();
    }
    ...
    /**
     * Creates a new {@link JiraRESTV2ProxySpec} with values taken from the proxy environment variables, if applicable.
     */
    public static JiraRESTV2ProxySpec detect() {
        ...
        for (String p : proxies) {
            try {
                ...
                return new JiraRESTV2ProxySpec(spec -> {
